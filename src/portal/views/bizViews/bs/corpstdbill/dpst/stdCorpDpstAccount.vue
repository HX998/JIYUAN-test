      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstAccount/func_queryStdCreationAccount"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="account('account')" >{{$t("m.i.bs.account")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams(optType) {
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstAccount/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstAccount/func_queryStdCorpDpstBillPage";
      ...
      stdCreationDetailOpen(id){
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstAccount/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstAccount/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstAccount/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstAccount/func_queryStdCorpOrgHolderPage";
