      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstSign/func_queryStdCreationSign"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdCreationOperate('signReply')" >{{$t("m.i.bs.sign")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams(optType) {
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstSign/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstSign/func_queryStdCorpDpstBillPage";
      ...
      stdCreationDetailOpen(id){
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstSign/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstSign/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstSign/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstSign/func_queryStdCorpOrgHolderPage";
