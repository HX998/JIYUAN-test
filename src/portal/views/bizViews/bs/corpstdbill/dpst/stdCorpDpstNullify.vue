      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstNullify/func_queryStdCreationNullify"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdCreationOperate('dpstNullify')" >{{$t("m.i.bs.nullify")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
      ...
      stdCreationOperate(str){
        ...
        this.$hMsgBox.confirm({
          ...
          onOk: () => {
            ...
            let url = "/bs/corpstdbill/dpst/stdCorpDpstNullify/func_nullifyStdDpst";
      ...
      stdCreationDetailOpen(id){
        this.creationId = id;
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstNullify/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstNullify/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstNullify/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstNullify/func_queryStdCorpOrgHolderPage";
