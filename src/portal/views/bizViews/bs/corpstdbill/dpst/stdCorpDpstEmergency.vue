      ...
      <h-col span="24">
        <div>
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <!--产品期限(天)-->
                <common-type-field-range v-model="formItem" :rangeProps="['minCreationTerm','maxCreationTerm']"  :integerNum="3":suffixNum="0"
                                         :label="$t('m.i.bs.creationTerm')" prop="remainingPeriod"
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_queryStdCreationEmergency"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdCreationOperate('emergency')" >{{$t("m.i.bs.emergencyBack")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams(optType) {
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_queryStdCorpDpstBillPage";
      ...
      stdCreationDetailOpen(id){
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstEmergency/func_queryStdCorpOrgHolderPage";
