...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstReturnApply/func_queryStdCorpDpstReturnApply"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="returnTicket()" >{{$t("m.i.bs.returnTicket")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    ...
    <!-- 退票弹窗 -->
    <std-corp-dpst-return-ticket :stdCorpDpstReturnTicketWin="stdCorpDpstReturnTicketWin" :batchParams="batchParams"
                    @stdCorpDpstReturnTicketWinClose="stdCorpDpstReturnTicketWinClose" ref="stdCorpDpstReturnTicket"></std-corp-dpst-return-ticket>
...
<script>
  ...
  export default {
    name: "stdCorpDpstReturnApply",
    components: {
      ShowCpesBranch:()=>import(/* webpackChunkName: "shcpe/cpes/branch/showCpesBranch" */`@/views/bizViews/shcpe/cpes/branch/showCpesBranch`),
      StdCorpDpstReturnTicket: () => import(/* webpackChunkName: "bs/corpstdbill/dpst/stdCorpDpstReturnTicket" */`@/views/bizViews/bs/corpstdbill/dpst/stdCorpDpstReturnTicket`),
    ...
    data() {
      return {
        ...
        controlModeList:[],
        calFeeTypeList:[],
        stdCorpDpstReturnTicketWin:false,
        batchParams: {},
    ...
    // 根据弹框所选数据进行赋值
      ...
      returnTicket(){
        ...
        this.batchParams.stdProductNo= this.currentSelectRow.stdProductNo;
        this.batchParams.stdProductShortName= this.currentSelectRow.stdProductShortName;
        this.batchParams.stdProductName= this.currentSelectRow.stdProductName;
        this.batchParams.ecdsAcctNo= this.currentSelectRow.ecdsAcctNo;
        this.batchParams.ecdsAcctName= this.currentSelectRow.ecdsAcctName;
        this.stdCorpDpstReturnTicketWin = true;
      },
      //关闭新增、修改弹窗
      stdCorpDpstReturnTicketWinClose() {
        this.stdCorpDpstReturnTicketWin = false;
      ...
      stdCreationDetailOpen(id){
        this.creationId = id;
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstReturnApply/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstReturnApply/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstReturnApply/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstReturnApply/func_queryStdCorpOrgHolderPage";
