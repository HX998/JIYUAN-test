      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/dpst/stdCorpDpstReply/func_queryStdCreationReply"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdCreationOperate('dpstReply')" >{{$t("m.i.common.confirm")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams(optType) {
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstReply/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstReply/func_queryStdCorpDpstBillPage";
      ...
      stdCreationDetailOpen(id){
        ...
        this.batchParams.batchUrl="/bs/corpstdbill/dpst/stdCorpDpstReply/func_findStdCorpDpstById";
        this.batchParams.dataGridUrl="/bs/corpstdbill/dpst/stdCorpDpstReply/func_queryStdCorpDpstBillPage";
        this.batchParams.creditMainUrl = "/bs/corpstdbill/dpst/stdCorpDpstReply/func_queryStdCreditMainPage";
        this.batchParams.orgHolderUrl = "/bs/corpstdbill/dpst/stdCorpDpstReply/func_queryStdCorpOrgHolderPage";
