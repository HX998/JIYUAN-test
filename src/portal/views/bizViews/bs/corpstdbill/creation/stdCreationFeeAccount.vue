...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/creation/stdCreationFeeAccount/func_queryStdCreationFee"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdCreationFeeShow()">{{$t("m.i.bs.feeAcct")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    ...
    <!-- 收费记账弹窗 -->
    <std-creation-fee-show :stdCreationFeeShowWin="stdCreationFeeShowWin" :batchParams="batchParams" :dictMap="dictMap"
                           @stdCreationFeeShowWinClose="stdCreationFeeShowWinClose" ref="stdCreationFeeShow"></std-creation-fee-show>
...
<script>
  ...
  export default {
    name: "stdCreationFeeAccount",
    components: {
      ShowCpesBranch:()=>import(/* webpackChunkName: "shcpe/cpes/branch/showCpesBranch" */`@/views/bizViews/shcpe/cpes/branch/showCpesBranch`),
      StdCreationFeeShow: () => import(/* webpackChunkName: "bs/corpstdbill/creation/stdCreationFeeShow" */`@/views/bizViews/bs/corpstdbill/creation/stdCreationFeeShow`),
    },
    data() {
      return {
        creationAmtRule:[{
    ...
    // 根据弹框所选数据进行赋值
      ...
      stdCreationFeeShow(){
        ...
        this.stdCreationFeeShowWin = true;
      },
      ...
      stdCreationFeeShowWinClose() {
        this.stdCreationFeeShowWin = false;
