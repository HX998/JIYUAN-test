...
<template>
  <div>
    <h-msg-box v-model="tempStdPaymentDetailWin" :maximize="true" :mask-closable="false" @on-close="handleClose"
      ...
      <div>
        ...
        <h-datagrid
          ...
          highlight-row
          :auto-load="false"
          url="/bs/corpstdbill/payment/stdPayment/func_queryStdCreationBill"
...
<script>
  ...
  export default {
    ...
    computed: {
      tempStdPaymentDetailWin: {
        get() {
          return this.stdPaymentDetailWin;
        },
        set() {
        }
      }
    ...
    methods: {
      ...
      queryObjById() {
        ...
        let url = "/bs/corpstdbill/payment/stdPayment/func_jumpStdPaymentConfirmShow";
      ...
      handleClose() {
        ...
        this.batchId="";
        this.$emit("stdPaymentDetailWinClose", "");
      },
      billInfoWinClose(){
        this.billId=null;
        this.billNo=null;
