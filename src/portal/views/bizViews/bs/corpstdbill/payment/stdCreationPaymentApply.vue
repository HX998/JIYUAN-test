...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <!--认购日期-->
                <common-date-picker v-model="paymentDt" :label="$t('m.i.bs.paymentDt')" type="daterange" :autoPlacement="true" @on-change="handlePaymentDtChange"></common-date-picker>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/payment/stdPayment/func_queryStdPaymentApply"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdPaymentConfirmApply()">{{$t("m.i.bs.paymentApply")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    ...
    <!-- 记账申请确认弹窗 -->
    <std-payment-confirm-apply :stdPaymentConfirmApplyWin="stdPaymentConfirmApplyWin" :batchParams="batchParams" :dictMap="dictMap"
                           @stdPaymentConfirmApplyWinClose="stdPaymentConfirmApplyWinClose" ref="stdPaymentConfirmApply"></std-payment-confirm-apply>
...
<script>
  ...
  export default {
    name: "stdCreationPaymentApply",
    components: {
      ShowCpesBranch:()=>import(/* webpackChunkName: "shcpe/cpes/branch/showCpesBranch" */`@/views/bizViews/shcpe/cpes/branch/showCpesBranch`),
      StdPaymentConfirmApply: () => import(/* webpackChunkName: "bs/corpstdbill/payment/stdPaymentConfirmApply" */`@/views/bizViews/bs/corpstdbill/payment/stdPaymentConfirmApply`),
    },
    data() {
      return {
        creationAmtRule:[{
        ...
        stdPaymentConfirmApplyWin: false,
    ...
    // 根据弹框所选数据进行赋值
      ...
      stdPaymentConfirmApply(){
        ...
        this.stdPaymentConfirmApplyWin = true;
      },

      stdPaymentConfirmApplyWinClose() {
        this.stdPaymentConfirmApplyWin = false;
