      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/underwrite/stdBookKeepingReply/func_queryStdBookKeepingPage"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdBookKeepingPass()" >
                {{$t("m.i.common.pass")}}
              </h-button>
              <h-button type="primary" @click="stdBookKeepingBack()" >
                {{$t("m.i.common.back")}}
              </h-button>
            </div>
          </h-datagrid>
  ...
  export default {
    ...
    methods: {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url = "/bs/corpstdbill/underwrite/stdBookKeepingReply/func_agreeStdBookKeeping";
      ...
      stdBookKeepingBack() {
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              let params = {id: this.currentSelectRow.id};
              let url = "/bs/corpstdbill/underwrite/stdBookKeepingReply/func_refuseStdBookKeeping";
              this.sendPost(params, url);
            }
          });
        } else {
      ...
      stdBookKeepingDetailOpen(id) {
        ...
        this.batchParams.bookKeepingUrl="/bs/corpstdbill/underwrite/stdBookKeepingReply/func_findStdBookKeepingById";
