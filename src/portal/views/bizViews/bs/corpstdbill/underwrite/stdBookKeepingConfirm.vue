      ...
      <h-col span="24">
        <div>
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <query-btn :advanceShow="false" :formSearch="handleSearch"
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/underwrite/stdBookKeepingConfirm/func_queryStdBookKeepingPage"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="stdBookKeepingConfirm()" :disabled="hasCommit">
...
<script>
  ...
  export default {
          ...
          },
          {
            ...
            render: (h, params) => {
              return h('a', {
                on: {
                  click: () => {
                    this.stdBookKeepingDetailOpen(params.row.id,"confirmQuery")
                  }
                }
              }, params.row.batchNo)
            }
    ...
    methods: {
      ...
      stdBookKeepingConfirm(){
        if(this.currentSelectRow != null && this.currentSelectRow.length !== 0){
          this.stdBookKeepingDetailOpen(this.currentSelectRow.id,"confirm");
        }else{
          this.$msgTip.info(this, {info: this.$t("m.i.common.chooseDataFirst")})
          return;
        }
      },
      stdBookKeepingDetailOpen(id,type) {
        this.batchParams.bkId = id;
        this.batchParams.bookResultPage = type;
        this.batchParams.dictMap = this.dictMap;
