...
<template>
  <div class="layout">
    <h-row name="flex" class="layout-menu-wrapper">
      <h-col span="24">
        ...
        <h-datagrid
          :columns="columns"
          highlightRow
          url="/bs/corpstdbill/underwrite/stdCreationReexchangeCheck/func_queryStdCreationReexchangeCheckByPage"
          :bindForm="formItem"
          :onCurrentChange="handleCurrentChange"
          :onCurrentChangeCancel="handleCurrentChangeCancel"
          ref="datagrid">
          <div slot="toolbar" class="pull-left">
            <h-button type="primary" @click="stdReexchangeCheck()">{{$t('m.i.common.registerCheck')}}</h-button>
          </div>
        </h-datagrid>
      </h-col>
    </h-row>
    ...
    <!-- 退汇复核明细页面 -->
    <std-reexchange-detail :stdReexchangeDetailWin="stdReexchangeDetailWin" :batchParams="batchParams"
                              @stdReexchangeDetailWinClose="stdReexchangeDetailWinClose" ref="stdReexchangeDetail"></std-reexchange-detail>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "stdCreationReexchangeCheck",
    components: {
      ...
      StdReexchangeDetail:() =>import(/* webpackChunkName: "bs/corpstdbill/underwrite/stdReexchangeDetail" */`@/views/bizViews/bs/corpstdbill/underwrite/stdReexchangeDetail`),
    },
    data() {
      return {
        acctRecordParam: {},
        acctRecordUrl:"/bs/corpstdbill/underwrite/stdUnderwriteAccount/func_getStdUnderwriteAcctRecord",
    ...
    methods: {
      ...
      stdReexchangeCheck() {
        ...
        this.stdReexchangeDetailWin = true;
      },
      //关闭退汇登记复核详情页面
      stdReexchangeDetailWinClose() {
        this.stdReexchangeDetailWin = false;
