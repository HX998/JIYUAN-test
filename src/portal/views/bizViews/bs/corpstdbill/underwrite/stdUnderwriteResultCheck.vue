      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/bs/corpstdbill/underwrite/stdUnderwriteResultCheck/func_queryStdUnderwriteResultCheckByPage"
            :bindForm="formItem"
            :row-select="true"
            :has-select="false"
            ref="datagrid">
      ...
      pass() {
        ...
        this.$hMsgBox.confirm({
          ...
          onOk: () => {
            ...
            let params = {ids: ids};
            let url = "/bs/corpstdbill/underwrite/stdUnderwriteResultCheck/func_passStdUnderwriteResult";
      ...
      reject() {
        ...
        this.$hMsgBox.confirm({
          ...
          onOk: () => {
            let ids = this.$refs.datagrid.selectIds.join(",");
            let params = {ids: ids};
            let url = "/bs/corpstdbill/underwrite/stdUnderwriteResultCheck/func_rejectStdUnderwriteResult";
            this.sendPost(params, url);
          }
        });
      },
