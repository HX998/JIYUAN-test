  ...
  <div>
    ...
    <div v-if="isShow">
      <div class="text-wrap mb-10">
        ...
        <h-form :model="formItem" :label-width="120" ref="formItem" cols="2" class="h-form-search">
          ...
          <h-form-item :label="$t('m.i.be.pawneeName')+':'">
            {{formItem.custName}}
          </h-form-item>
          <h-form-item :label="$t('m.i.be.pawneeBrchCode')+':'">
          ...
          <h-form-item :label="$t('m.i.be.pledgorBrchName')+':'">
            {{formItem.brchName}}
          </h-form-item>
        </h-form>
      </div>
    ...
    <div v-if="isShow">
      <h-datagrid
        ...
        highlight-row
        :bindForm="formItem"
        url="/be/trust/impawn/impawnApply/func_queryImpawnApplyBillByIds"
        :row-select="true"
        :has-select="false"
        ref="billDatagrid">
        <div slot="toolbar">
  ...
  export default {
    ...
    methods: {
      ...
      init() {
        ...
        let url = "";
        if (batchId) {
          url = "/be/trust/impawn/impawnApply/func_getImpawnBatchById";
        } else {
