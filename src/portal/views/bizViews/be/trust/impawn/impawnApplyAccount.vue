<template>
  <div class="layout">
    ...
    <h-msg-box v-model="addOrEditWin" width="1000" height="400" class="h-form-table-layer"
               @on-close="handleWinClose" @on-maximize="onMaximize" :maximize="true" :footerHide="true">
      <p slot="header">
      ...
      <h-datagrid
        ...
        ref="datagridbill">
        <div slot="toolbar" class="pull-left">
          <h-dropdown trigger="click" @on-click="applyAccount" v-if="authObj.bizSetRoleAdd">
  ...
  export default {
    ...
    data() {
      return {
        ...
        authPath: this.$route.path,
       // brchNoWin: false,
        acctRecord: "/pb/trust/impawn/impawnApplyAccount/func_queryAcctRecord",
        param: {},
    ...
    methods: {
      ...
      queryBillList(obj) {
        if (this.isRollBack) {
          //post(obj, "pb/trust/impawn/impawnApplyAccount/func_queryImpawnApplyAcctBill").then(res => {
      ...
      applyAccount(obj) {
        ...
        if (obj == "selectAccout" && this.currentSelectBillList.length == 0) {
          ...
          Object.assign(this.param, { "impawnIds": this.addForm.impawnIds,"operType":this.addForm.operType, "batchId": this.addForm.batchId ,
      ...
      account() {
        ...
        post(this.addForm, "/pb/trust/impawn/impawnApplyAccount/func_accountApplyImpawnBill").then(res => {
