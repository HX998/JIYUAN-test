...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            ...
            row-select
            :has-select="false"
            url="/be/trust/ownership/owershipChangeOutBankBillAcct/func_queryPendingAcctOwershipChangeOutBill"
            :bindForm="formItem"
            ref="datagrid">
    ...
    <acct-record :param="param"
                 ...
                 url="/be/trust/ownership/owershipChangeOutBankBillAcct/func_queryOutAcctRecord"
...
export default {
  name: "owershipChangeOutBankBillAcct",
  data() {
    return {
      dictMap: new Map(),
      billId : "",
      ...
      columns: [
        ...
        {
          title: this.$t('m.i.be.owershipIntoName'),
          key: "transToName",
          hiddenCol: false,
  ...
  methods: {
    ...
    applyAccount(info) {
      ...
      post({ ids: info.ids }, "/be/trust/ownership/owershipChangeOutBankBillAcct/func_accountOwershipChangeBankOutBills").then(res => {
