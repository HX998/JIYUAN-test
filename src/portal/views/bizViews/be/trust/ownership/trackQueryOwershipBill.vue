      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/be/trust/ownership/trackQueryOwershipBill/func_trackQueryOwershipBill"
                      :bindForm="formItem"
                      :hasSelect="false"
                      rowSelect
                      ref="datagrid">
  ...
  export default {
    ...
    methods: {
      ...
      tempShowExcelTemplateWinOpen() {
        this.param = "registOwershipQueryReportInfo";
      ...
      exportList(field, exportType) {
        let exportUrl = window.LOCAL_CONFIG.API_HOME + "/be/trust/ownership/trackQueryOwershipBill/func_exportExcel";
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
