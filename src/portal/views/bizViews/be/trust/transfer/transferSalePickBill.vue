<template>
  <div>
    <h-msg-box v-model="tempPickBillWin" width="1000" :mask-closable="false" @on-close="handleClose"
      ...
      <div :class="{'h-form-overhd':!ifShowMore}">
        <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
          ...
          <h-form-item :label="$t('m.i.be.buyDt')" prop="rangeBuyDt">
            <h-date-picker :value="rangeBuyDt" type="daterange" placeholder="" format="yyyy-MM-dd"
                           showFormat @on-change="handleBuyDtChange"></h-date-picker>
          </h-form-item>
          <h-form-item :label="$t('m.i.be.rate')" prop="rate">
            <h-input v-model="formItem.minBuyRatePct" style="width: 63px" integerNum="2"
                     suffixNum="4"></h-input>
            <span>-</span>
            <h-input v-model="formItem.maxBuyRatePct" style="width: 63px" integerNum="2"
                     suffixNum="4"></h-input>
          </h-form-item>
          <!--票据来源-->
      ...
      <h-row>
        <h-col span="24">
          <h-datagrid
            :columns="columns"
            highlight-row
            url="/be/trust/transfer/transferSaleApplyMain/func_queryPendingTransferSaleApplyBill"
            :bindForm="formItem"
            :paramId="'hldrId'"
...
<script>
  ...
  export default {
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            hiddenCol: false,
            render: (h, params) => {
              let transDt = params.row.transDt == null ? "" : this.$moment(params.row.transDt, "YYYYMMDD").format("YYYY-MM-DD");
              return h("span", transDt);
            }
          },
          {
            ...
            render: (h, params) => {
              ...
              // return h("span", params.row.buyRate * 100);
            }
          },
          {
        ...
        datagridUrl: "/be/trust/transfer/transferSaleApplyMain/func_queryPendingTransferSaleApplyBill",
        ifShowMore: false,
        dictMap: null,
        billTypeList: [],
        billClassList: [],
    ...
    watch: {
      pickBillWin(val) {
        if (val === true) {
          this.datagridUrl = "/be/trust/transfer/transferSaleApplyMain/func_queryPendingTransferSaleApplyBill";
    ...
    methods: {
      ...
      formSearch() {
        ...
        this.formItem.minBuyRate = this.formItem.minBuyRatePct ? this.formItem.minBuyRatePct * 0.01 : "";
        this.formItem.maxBuyRate = this.formItem.maxBuyRatePct ? this.formItem.maxBuyRatePct * 0.01 : "";
      ...
      formSearchReset() {
        this.rangeDueDt = [];
        this.rangeBuyDt = [];
        this.formItem.minBuyRate = "";
        this.formItem.maxBuyRate = "";
        this.formItem.minBuyRatePct = "";
        this.formItem.maxBuyRatePct = "";
