        ...
        <div>
          ...
          <div class="h-form-search-box" :class="{'h-form-overhd':!ifShowMore}">
            <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
              ...
              <h-form-item :label="$t('m.i.billInfo.remitDt')" prop="acptDt">
                <h-date-picker :value="rangeRemitDt" type="daterange" autoPlacement placement="bottom-end" placeholder=""
                               format="yyyy-MM-dd" @on-change="handleRemitDtChange"></h-date-picker>
              </h-form-item>
              <h-form-item :label="$t('m.i.billInfo.dueDt')" prop="dueDt">
                <h-date-picker :value="rangeDueDt" type="daterange" autoPlacement placement="bottom-end" placeholder=""
  ...
  export default {
    ...
    data() {
      return {
        ...
        datagridUrl: "/bp/guaranty/sign/func_querySigningBillInfo",
        ifShowMore: false,
        currentSelectList: [],
        dictMap: null,
        billOriginList:[],
      ...
      pickCodeWin(val) {
        if (val === true) {
          this.$nextTick(() => {
            ...
            this.formItem.applBrchCode = this.applBrchCode;
            this.formItem.custBrchCode = this.applBrchCode;
            this.datagridUrl = "/bp/guaranty/sign/func_querySigningBillInfo";
            this.formSearch();
          });
        }
      },
