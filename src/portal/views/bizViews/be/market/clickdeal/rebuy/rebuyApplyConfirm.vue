      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
              :columns="columns"
              highlightRow
              url="/be/market/clickdeal/rebuy/rebuyApplyConfirm/func_getClickDealRebuyCheck"
              :bindForm="formItem"
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.getDictListByGroups("BusiType,TrDir,Yon,TradeRange,DraftTypeCode,CDMedia,ClearSpeed,SettleType,ClearType,CreditMajor,ClearMode,BrchClass,QuoteStatus,BillOrigin").then(res => {
        ...
        if (this.currentSelectRow != null) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              this.sendPost(params, "/be/market/clickdeal/rebuy/rebuyApplyConfirm/func_sendClickQuoteApply");
            }
          });
        } else {
      ...
      returnApply(){
        if (this.currentSelectRow != null) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              let params={batchId:this.currentSelectRow.id};
              this.sendPost(params, "/be/market/clickdeal/rebuy/rebuyApplyConfirm/func_rejectClickQuoteApply");
            }
          });
        } else {
          this.$msgTip.info(this, { info: this.$t("m.i.common.chooseOneData") });
