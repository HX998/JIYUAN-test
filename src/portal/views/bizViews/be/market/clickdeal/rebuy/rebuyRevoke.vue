...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
              :columns="columns"
              highlightRow
              url="/be/market/clickdeal/rebuy/rebuyRevoke/func_getClickDealRebuyCancel"
              :bindForm="formItem"
              :onCurrentChange="handleCurrentChange"
              :onCurrentChangeCancel="handleCurrentChangeCancel"
              ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="revokeAppl">{{$t('m.i.be.revokeAppl')}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    ...
    <rebuy-detail :rebuyDetailWin="rebuyDetailWin" :detailParams="detailParams" @rebuyDetailWinClose="rebuyDetailWinClose"></rebuy-detail>
  </div>
</template>
        ...
        if (this.currentSelectRow != null) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              this.sendPost(params, "/be/market/clickdeal/rebuy/rebuyRevoke/func_cancelClickDealRebuyBatch");
            }
          });
        } else {
