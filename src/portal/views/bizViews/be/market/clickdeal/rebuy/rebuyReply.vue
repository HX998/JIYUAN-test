...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
              :columns="columns"
              highlightRow
              url="/be/market/clickdeal/rebuy/rebuyReply/func_getClickDealRebuySubBatch"
              :bindForm="formItem"
    ...
    <quote-rebuy-detail :batchId="batchId" :dictMap="dictMap" busiType="BT01" :rebuyDetailWin="rebuyDetailWin"
                  @closeMsgBox="rebuyDetailWinClose" :rootUrl="rootUrl"></quote-rebuy-detail>
    <!--受理-->
    <rebuy-deal-display-acpt :saleOrRebuyDealDisplayAcptWin="rebuyDealDisplayAcptWin" :batchParams="batchParams"
                             ...
                             dataGridUrl="/be/market/clickdeal/rebuy/rebuyReply/func_getClickDealRebuyBillList"></rebuy-deal-display-acpt>
  </div>
</template>
v
<script>
  ...
  export default {
    name: "rebuyReply",
    components: {
      QuoteRebuyDetail: () => import(/* webpackChunkName: "be/market/clickdeal/rebuy/quoteRebuyDetail" */`@/views/bizViews/be/market/clickdeal/rebuy/quoteRebuyDetail`),
    ...
    data() {
      return {
        ...
        rootUrl:"/be/market/clickdeal/rebuy/rebuyReply",
        detailParams: {},
    ...
    mounted() {
      this.getDictListByGroups("QuoteBusiType,AssetIndustry,TrDir,Yon,TradeRange,DraftTypeCode,CDMedia,ClearSpeed,SettleType,ClearType,CreditMajor,BrchClass,PreRelationFlag,QuoteStatus,ClearMode,PreTradeBhvr,BillOrigin").then(res => {
    ...
    methods: {
      ...
      handleOperate() {
        post({ subBatchId: this.currentSelectRow.id }, "/be/market/clickdeal/rebuy/rebuyReply/func_deleteClickRebuySubBatch").then(res => {
          if (res) {
      ...
      modify() {
        ...
        this.batchParams.queryBatchIdUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_getRcvRebuyBatchSub";
        this.batchParams.pickBillSubmitUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_addClickDealRebuyBill";
        this.batchParams.pickDataGridUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_queryClickDealRebuyBill";
        this.batchParams.importPickBillUploadUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_batchPickBillStock";
        this.batchParams.calcInterestUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_calcInterestSub";
        this.batchParams.applySubmitUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_clickDealSubCommitApply";
        this.batchParams.deleteBillUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_deleteBillSub";
        this.batchParams.importTemplateUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_downloadSaleBill";
        this.batchParams.exportBillUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_downloadRebuyInfo";
        this.batchParams.saveBatchFuncUrl = "/be/market/clickdeal/rebuy/rebuyReply/func_editClickDealRebuySub";
