...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
              :columns="columns"
              highlightRow
              url="/be/market/clickdeal/sale/saleRevoke/func_queryPreCancelSaleBatchList"
              :bindForm="formItem"
    ...
    <show-trans-brch-type :transBrchTypeWin="showTransBrchTypeWin" displayType="show"
                          ...
                          datagridUrl="/be/market/clickdeal/sale/saleRevoke/func_queryBranchClass"></show-trans-brch-type>
    <!--批次链接详细展示框-->
        ...
        if (this.currentSelectRow != null) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              this.sendPost(params, "/be/market/clickdeal/sale/saleRevoke/func_cancelClickSaleApply");
            }
          });
        } else {
