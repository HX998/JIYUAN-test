  ...
  <div>
    ...
    <div v-if="isShow">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatDict("QuoteBusiType",viewDetailForm.busiType)}}</h-col>
              </h-row>
            </h-col>
            <!--批次号-->
            <h-col span="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{viewDetailForm.saleBrchName}}</h-col>
              </h-row>
            </h-col>
            <!--本方交易员名称-->
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{viewDetailForm.saleTraderName}}</h-col>
              </h-row>
            </h-col>
            <!--对方机构名称-->
            <h-col span="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{viewDetailForm.buyBrchCode}}</h-col>
              </h-row>
            </h-col>
            <!--对方非法人产品-->
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{viewDetailForm.buyProductName}}</h-col>
              </h-row>
            </h-col>
            <!--对方交易员名称-->
            <h-col span="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{viewDetailForm.buyTraderNo}}</h-col>
              </h-row>
            </h-col>
            <!--票据种类-->
            <h-col span="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatDict("Yon",viewDetailForm.subDeal)}}</h-col>
              </h-row>
            </h-col>
            <!--清算类型-->
            <h-col span="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatDate(viewDetailForm.firstSettleDt)}}</h-col>
              </h-row>
            </h-col>
          </h-row>
          <h-row :gutter="8">
          ...
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatMoney(viewDetailForm.totalAmt)}}</h-col>
              </h-row>
            </h-col>
            <!--票据张数-->
            <h-col span="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatMoney(viewDetailForm.firstPayInterest)}}</h-col>
              </h-row>
            </h-col>
          </h-row>
          <h-row :gutter="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatMoney(viewDetailForm.firstSettleAmt)}}</h-col>
              </h-row>
            </h-col>
            <!--加权平均剩余期限-->
            <h-col span="8">
            ...
            <h-col span="8">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatRate(viewDetailForm.yieldRatePct)}}</h-col>
              </h-row>
            </h-col>
          </h-row>
        </div>
      ...
      <h-datagrid
        ...
        url="/be/market/clickdeal/sale/saleReplyAudit/func_getSubClickSaleBillList"
        ref="billDatagrid">
        <div slot="toolbar">
        </div>
      </h-datagrid>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.billFormItem.listIds = this.listIds;
    },
    mounted() {
      this.getDictListByGroups("DraftTypeCode,CDMedia,AssetIndustry,ClearType,SettleType,ClearSpeed,CreditMajor,QuoteBusiType,PreRelationFlag,Yon,BillOrigin").then(res => {
    ...
    methods: {
      ...
      init() {
        ...
        let url = "";
        if (batchId) {
          url = "/be/market/clickdeal/sale/saleReplyAudit/func_findClickSaleSubBatchById";
        } else {
          this.$msgTip.error(this, { info: "批次ID不能为空" });
        }
        post({ batchId: batchId,listIds: this.listIds }, url).then(res => {
          if (res && res.data) {
