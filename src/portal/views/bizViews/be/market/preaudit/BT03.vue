<template>
  <div class ="out-side">
    <div>
      ...
      <h-form-item :label="$t('m.i.be.firstTransRate')" prop="ratePct" required  class="h-form-three h-form-long-label" :validRules="ratePctRule">
        <h-input v-model="formItem.ratePct" placeholder="利率范围0~100，且小数位不超过四位" ></h-input>
      </h-form-item>
      <h-form-item :label="$t('m.i.be.dueTransRate')" prop="dueRatePct" required class="h-form-three h-form-long-label" :validRules="ratePctRule">
    ...
    <div>
      ...
      <h-form-item :label="$t('m.i.be.dueInterest')" prop="dueInterest"  class="h-form-three h-form-long-label">
        <h-input v-model="formItem.dueInterest" placeholder="" readonly></h-input>
      </h-form-item>
