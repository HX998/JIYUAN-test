  ...
  export default {
    ...
    data() {
      return {
        ...
        batchsUrl : "/be/market/quote/sale/saleAccount/func_queryBatch",
        acctRecord : "/be/market/quote/sale/saleAccount/func_queryAcctRecord",
        accountUrl : "/be/market/quote/sale/saleAccount/func_saleAccount",
        rootUrl:"/be/market/quote/sale/saleAccount",
    ...
    mounted() {
      this.getDictListByGroups('PreRelationFlag,Yon,AssetIndustry,CdSelectMode,QuoteStatus,QuoteBusiType,SettleType,ClearType,ClearSpeed,CDMedia,DraftTypeCode,CreditMajor,BillOrigin').then(res => {
