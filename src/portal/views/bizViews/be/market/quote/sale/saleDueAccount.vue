    ...
    <h-row name="flex" class="layout-menu-wrapper">
      <h-col span="24">
        <div>
          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="saleAccountQueryItem" :label-width="90" ref="saleAccountQueryItem" cols="4" class="h-form-search">
                <show-branch v-model="saleAccountQueryItem.ownedBrchNames"  :label="$t('m.i.common.ownedBrchNo')"      prop="ownedBrchNames"
                             v-if="this.licenseFlag"   :showCheckBox="true"     :brchNo.sync="saleAccountQueryItem.ownedBrchNos" :brchName.sync="saleAccountQueryItem.ownedBrchNames"
                ...
                <h-form-item :label="$t('m.i.common.busiType')" prop="busiType">
                  <h-select v-model="saleAccountQueryItem.busiType" placeholder="" showTitle>
                    <h-option v-for="item in busiTypeList" :value="item.key" :key="item.value"  v-if="item.key !== 'BT01'">{{ item.value }}</h-option>
                  </h-select>
                </h-form-item>
          ...
          <h-row>
            <h-col span="24">
              <h-datagrid :columns="dataColumns" hasPage highlight-row url="/be/market/quote/sale/saleDueAccount/func_findDueAccountBatchList"
  ...
  export default {
    ...
    data() {
      return {
        ...
        batchId : "",
        url : "/be/market/quote/sale/saleDueAccount/func_getDueAcctRecord",
        ...
        rootUrl:"/be/market/quote/sale/saleDueAccount",
         dataColumns : [
          {
            type: "radio",
            width: 50,
    ...
    methods: {
      ...
      //确定记账，发送记账请求
      acctSubmitSure(obj) {
        let url = "/be/market/quote/sale/saleDueAccount/func_dueAccount";
        let id = obj.id;
    ...
    mounted() {
      this.getDictListByGroups("PreRelationFlag,AssetIndustry,Yon,CdSelectMode,QuoteStatus,DraftTypeCode,AcctFlag,ClearType,QuoteBusiType,SettleType,StlResult,PreTradeBhvr,CDMedia,DealStatus,MmbStlStatus,ClearSpeed,CreditMajor,BillOrigin").then(res => {
