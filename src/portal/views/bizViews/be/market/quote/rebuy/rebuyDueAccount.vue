          ...
          <!--数据展示表格-->
              <h-datagrid :columns="columns" highlight-row :url="batchsUrl" :bindForm="formItem" :onCurrentChange="onCurrentChange" :onCurrentChangeCancel="onCurrentChangeCancel" ref="datagrid">
                <div slot="toolbar" class="pull-left">
                  ...
                  <h-button type="primary" @click="setAssetType()" v-if="formItem.isNeedAssetIndustry=='1'" >{{$t('m.i.be.setAssetType')}}</h-button>
                </div>
              </h-datagrid>
        </div>
      </h-col>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        batchsUrl : "/be/market/quote/rebuy/rebuyDueAccount/func_findDueAccountBatch",
        acctRecord : "/be/market/quote/rebuy/rebuyDueAccount/func_getDueAcctRecord",
        accountUrl : "/be/market/quote/rebuy/rebuyDueAccount/func_dueAccount",
        dictMap : new Map(),
        busiType : "",
        batchId:'',
        ...
        selectData: [],
        showDetilBox: false,
        rootUrl:"/be/market/quote/rebuy/rebuyDueAccount",
        param: {},
