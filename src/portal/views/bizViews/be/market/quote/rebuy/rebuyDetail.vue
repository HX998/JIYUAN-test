          ...
          <h-row :gutter="16">
            <h-col span="6">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatAmt(viewDatailForm.buyBackTotalAmt)}}</h-col>
              </h-row>
            </h-col>
            <h-col span="6">
              <h-row>
          ...
          <h-row :gutter="16">
            ...
            <h-col span="6">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatAmt(viewDatailForm.dueSettleAmt)}}</h-col>
              </h-row>
            </h-col>
            <h-col span="6">
              <h-row>
          ...
          <h-row :gutter="16">
            ...
            <h-col span="6">
              <h-row>
                ...
                <h-col span="15" class="val">{{formatAmt(viewDatailForm.dueInterest)}}</h-col>
              </h-row>
            </h-col>
            <h-col span="6">
              <h-row>
  ...
  export default {
      ...
      return {
        ...
        billsColumns: [
          ...
          },
          {
            ...
            hiddenCol: true,
            render: (h, params) => {
              let dictValue = this.getDictValueFromMap(this.dictMap, "CreditDeductRule", params.row.creditOccupyType);
              return h("span", {
                domProps: {
                  title: dictValue
                }
...

          {
            ...
            hiddenCol: true,
            render: (h, params) => {
              let dictValue = this.getDictValueFromMap(this.dictMap, "BookType", params.row.bookType);
              return h("span", {
                domProps: {
                  title: dictValue
                }
    ...
    watch: {
      rebuyDetailWin(i) {
        if (i == true) {
          if (this.rootUrl) {
            this.batchUrl = this.rootUrl + "/func_findRebuyBatchById";
            this.billsUrl = this.rootUrl + "/func_queryRebuyBillList";
          } else {
            this.batchUrl = "/be/market/quote/quoteManager/func_findRebuyBatchById";
            this.billsUrl = "/be/market/quote/quoteManager/func_queryRebuyBillList";
          }
