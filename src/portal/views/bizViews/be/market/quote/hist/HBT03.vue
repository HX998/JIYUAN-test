    ...
    <div class ="out-side">
        <div>
             ...
             <h-form-item :label="$t('m.i.be.repoTerm')" prop="tenorDays" class="h-form-three">
                <h-input v-model="formItem.tenorDays" placeholder="" @on-blur="changeSettleDate" readonly></h-input>
            </h-form-item>
            <h-form-item :label="$t('m.i.be.dueSettleDt')" prop="dueSettleDt" class="h-form-three">
                 <h-date-picker v-model="formItem.dueSettleDt" format="yyyy-MM-dd" showFormat readonly></h-date-picker>
            </h-form-item>
            <h-form-item :label="$t('m.i.be.firstTransRate')" prop="ratePct" class="h-form-three h-form-long-label">
                <h-input v-model="formItem.ratePct" placeholder="" readonly></h-input>
            </h-form-item>
            <h-form-item :label="$t('m.i.be.dueTransRate')" prop="dueRatePct" class="h-form-three h-form-long-label">
                <h-input v-model="formItem.dueRatePct" placeholder="" readonly></h-input>
            </h-form-item>
           <h-form-item :label="$t('m.i.be.setTm')" prop="setTm" class="h-form-three">
                <h-time-picker v-model="formItem.setTm" placement="bottom-end"  placeholder="选择时间" readonly></h-time-picker>
            </h-form-item>
            <h-form-item :label="$t('m.i.be.quoteTm')" prop="quoteTm" class="h-form-three h-form-long-label">
                <h-time-picker   v-model="formItem.quoteTm" placement="bottom-end"  placeholder="选择时间" readonly></h-time-picker>
            </h-form-item>
        </div>
        <div>
            ...
            <h-form-item :label="$t('m.i.be.firstPayInterestByUnit')" prop="firstPayInterest"  class="h-form-three h-form-long-label">
