<template>
  <div class="layout">
        ...
        <div>
          ...
          <!--数据展示表格-->
              <h-datagrid :columns="columns" highlight-row :url="batchsUrl" :bindForm="formItem"
                          ...
                          :onCurrentChangeCancel="onCurrentChangeCancle" ref="datagrid">
    ...
    <redis-bill-detil :showBills="showDetilWin"
                      ...
                      :dictMap="dictMap"
                      :busi-type="busiType"
                      batchUrl="/be/market/rediscount/rediscountAccount/func_queryBatchById"
                      billsUrl="/be/market/rediscount/rediscountAccount/func_queryBills"
                      billImgsUrl="/be/market/rediscount/rediscountAccount/func_queryRediscountSaleImagePage"
   ...
   name : 'rediscountAccount',
    data() {
      return {
        ...
        batchsUrl : "/be/market/rediscount/rediscountAccount/func_queryBatchs",
        accountUrl : "/be/market/rediscount/rediscountAccount/func_account",
        acctRecord : "/be/market/rediscount/rediscountAccount/func_queryAcctRecord",
        selectData : null
      };
    },
    components: {
