...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_queryAnonyRebuyTrack"
            :bindForm="formItem"
    ...
    <!-- 子批页面 -->
    <rebuy-sub-batch-detail :rebuySubBatchDetailWin="rebuySubBatchDetailWin" :batchParams="batchParams"
                        @rebuySubBatchDetailWinClose="rebuySubBatchDetailWinClose" ref="rebuySubBatchDetail"></rebuy-sub-batch-detail>
...
<script>
  ...
  export default {
    ...
    components: {
      ...
      RebuySubBatchDetail: () => import(/* webpackChunkName: "be/market/anonyclick/rebuy/rebuySubBatchDetail" */`@/views/bizViews/be/market/anonyclick/rebuy/rebuySubBatchDetail`)
    },
    data() {
      return {
        quoteNoRules: [{
    ...
    methods: {
      ...
      viewRebuySubBatch(){
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          ...
          this.batchParams.batchUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_findAnonyRebuyBatchById";
          this.batchParams.billsUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_queryRebuyBatchList";
          this.batchParams.exportUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_downloadRebuyInfo";

          this.batchParams.subBatchUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_findRebuyBatchById";
          this.batchParams.subBillsUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_queryRebuyBillList";
          this.batchParams.subExportUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_downloadSubRebuyInfo";
          this.rebuySubBatchDetailWin=true;
        } else {
       ...
       * 关闭子批页面
       */
      rebuySubBatchDetailWinClose(){
        this.rebuySubBatchDetailWin = false;
      ...
      billDetail(id) {
        ...
        this.batchParams.dictMap = this.dictMap;
        this.batchParams.batchUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_findAnonyRebuyBatchById";
        this.batchParams.billsUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_queryAnonyRebuyBillList";
        this.batchParams.exportUrl="/be/market/anonyclick/rebuy/rebuyTrackQuery/func_downloadRebuyInfo";
