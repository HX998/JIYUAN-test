  ...
  export default {
    ...
    data() {
      return {
        ...
        batchsUrl : "/be/market/anonyclick/rebuy/rebuyDueAccount/func_findDueAccountBatch",
        acctRecord : "/be/market/anonyclick/rebuy/rebuyDueAccount/func_getDueAcctRecord",
        accountUrl : "/be/market/anonyclick/rebuy/rebuyDueAccount/func_dueAccount",
        dictMap : new Map(),
        busiType : "",
        batchId:'',
    ...
    methods: {
      ...
      showDetil(i,busiType) {
        ...
        this.batchParams.subBatchUrl="/be/market/anonyclick/rebuy/rebuyDueAccount/func_findRebuyBatchById";
        this.batchParams.subBillsUrl="/be/market/anonyclick/rebuy/rebuyDueAccount/func_queryRebuyBillList";
        this.batchParams.subExportUrl="/be/market/anonyclick/rebuy/rebuyDueAccount/func_downloadSubRebuyInfo";
