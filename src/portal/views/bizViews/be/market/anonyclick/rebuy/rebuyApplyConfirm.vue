      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/market/anonyclick/rebuy/rebuyApplyConfirm/func_queryAnonyRebuyReply"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="sendRebuyApply()">{{$t("m.i.common.send")}}</h-button>
              <h-button type="primary" @click="returnRebuyApply()">{{$t("m.i.be.returnApply")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/market/anonyclick/rebuy/rebuyApplyConfirm/func_sendAnonyRebuyApply";
      ...
      returnRebuyApply(){
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              let params={ id: this.currentSelectRow.id };
              let url="/be/market/anonyclick/rebuy/rebuyApplyConfirm/func_cancelAnonyRebuyApply";
              this.sendPost(params,url);
            }
          });
        } else {
      ...
      billDetail(id) {
        ...
        this.batchParams.batchUrl="/be/market/anonyclick/rebuy/rebuyApplyConfirm/func_findAnonyRebuyBatchById";
