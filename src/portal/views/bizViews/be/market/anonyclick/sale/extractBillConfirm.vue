      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/market/anonyclick/sale/extractBillConfirm/func_queryAnonySaleExtractReply"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.getDictListByGroups("QuoteBatchStatus,BusiType,TrDir,Yon,TradeRange,DraftTypeCode,CDMedia,ClearSpeed,SettleType,ClearType,CreditMajor,ClearMode,TenorVarieties,QuoteStatus,PreRelationFlag,BillOrigin").then(res => {
    ...
    methods: {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/market/anonyclick/sale/extractBillConfirm/func_sendAnonySaleExtractApply";
      ...
      returnSaleApply(){
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              let params={ id: this.currentSelectRow.id };
              let url="/be/market/anonyclick/sale/extractBillConfirm/func_cancelAnonySaleExtractApply";
              this.sendPost(params,url);
            }
          });
        } else {
      ...
      billDetail(id) {
        ...
        this.batchParams.subBatchUrl="/be/market/anonyclick/sale/extractBillConfirm/func_findSaleBatchById";
        this.batchParams.subBillsUrl="/be/market/anonyclick/sale/extractBillConfirm/func_querySaleBillList";
        this.batchParams.subExportUrl="/be/market/anonyclick/sale/extractBillConfirm/func_downloadSubSaleInfo";
