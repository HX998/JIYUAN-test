...
<template>
  <div>
    ...
    <!--本方机构名称-->
    <common-input v-model="addForm.saleBrchName" :label="$t('m.i.be.ownBrchName')" prop="saleBrchName"
                  :readonly="true"></common-input>
    <!--本方交易员名称-->
    <common-input v-model="addForm.saleTraderName" :label="$t('m.i.be.traderName')" prop="saleTraderName"
                  :readonly="true"></common-input>
    <!--票据种类-->
    ...
    <common-select v-model="addForm.creditMainBrchClass" :label="$t('m.i.billInfo.creditMainBankType')"
                   ...
                   :required="true"></common-select>
    <!--票据总额-->
    <common-type-field v-model="addForm.totalAmt" :label="$t('m.i.common.totalAmtBillPackage')" prop="totalAmt" :readonly="true"></common-type-field>
    <!--票据张数-->
    <common-input v-model="addForm.totalNum" :label="$t('m.i.common.totalNumBillPackage')" prop="totalNum" :readonly="true"></common-input>
  </div>
</template>
