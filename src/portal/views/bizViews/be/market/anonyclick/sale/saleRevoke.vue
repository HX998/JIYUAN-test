      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/market/anonyclick/sale/saleRevoke/func_queryAnonySaleCancel"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="cancelSaleApply()">{{$t("m.i.common.cancel")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    methods: {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/market/anonyclick/sale/saleRevoke/func_cancelAnonySaleSend";
      ...
      billDetail(id) {
        ...
        this.batchParams.batchUrl="/be/market/anonyclick/sale/saleRevoke/func_findAnonySaleBatchById";
        this.batchParams.billsUrl="/be/market/anonyclick/sale/saleRevoke/func_queryAnonySaleBillList";
        this.batchParams.exportUrl="/be/market/anonyclick/sale/saleRevoke/func_downloadSaleInfo";
