      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/market/anonyclick/sale/saleApply/func_queryAnonySaleApply"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    name: "saleApply",
    components: {
      SaleApplyAdd: () => import(/* webpackChunkName: "be/market/anonyclick/sale/saleApplyAdd" */`@/views/bizViews/be/market/anonyclick/sale/saleApplyAdd`),
    ...
    mounted() {
      this.getDictListByGroups("AnonyClickBatchStatus,BusiType,TrDir,Yon,TradeRange,DraftTypeCode,CDMedia,ClearSpeed,SettleType,ClearType,CreditMajor,ClearMode,TenorVarieties,QuoteStatus,PreRelationFlag,bankLevel,TenorCode,AnonyClickBillStatus,BillOrigin").then(res => {
    ...
    methods: {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/market/anonyclick/sale/saleApply/func_deleteAnonySaleBatch";
      ...
      billDetail(id) {
        ...
        this.batchParams.dictMap = this.dictMap;
        this.batchParams.batchUrl="/be/market/anonyclick/sale/saleApply/func_findAnonySaleBatchById";
        this.batchParams.billsUrl="/be/market/anonyclick/sale/saleApply/func_queryAnonySaleBillList";
        this.batchParams.exportUrl="/be/market/anonyclick/sale/saleApply/func_downloadSaleInfo";
