      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/discquote/broker/out/discOutReplyMain/func_queryDiscOutBatchReplyPage"
            :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      return {
        ...
        discBrchCode:"",
        showtrader : false,
        dataGridUrl: "/be/discquote/broker/out/discOutReplyMain/func_queryDiscOutBillPage",
        exportUrl: "/be/discquote/broker/out/discOutReplyMain/func_exportDiscOutBill",
        batchUrl: "/be/discquote/broker/out/discOutReplyMain/func_editDiscOut",
        filePathUrl: "/be/discquote/broker/out/discOutReplyMain/"
      };
    },
    mounted() {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/discquote/broker/out/discOutReplyMain/func_sendApplyOut";
      ...
      returnApply(){
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              let params={ id: this.currentSelectRow.id };
              let url="/be/discquote/broker/out/discOutReplyMain/func_rejectBackOut";
              this.sendPost(params,url);
            }
          });
        } else {
