      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/be/discquote/broker/listing/discListingRecallMain/func_queryDiscListingBatchRecallPage"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="listingRecall">{{$t("m.i.be.listingRecall")}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        dataGridUrl: "/be/discquote/broker/listing/discListingRecallMain/func_queryDiscListingBillPage",
        exportUrl: "/be/discquote/broker/listing/discListingRecallMain/func_exportDiscListingBill",
        batchUrl: "/be/discquote/broker/listing/discListingRecallMain/func_editDiscListing",
        transDataGridUrl: "/be/discquote/broker/listing/discListingRecallMain/func_queryBranchClassAndBranchCodePage",
        filePathUrl: "/be/discquote/broker/listing/discListingRecallMain/"
      };
    },
    mounted() {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url="/be/discquote/broker/listing/discListingRecallMain/func_recallApply";
