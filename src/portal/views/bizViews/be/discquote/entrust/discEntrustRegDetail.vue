...
<template>
  <div>
    <h-msg-box v-model="tempDiscEntrustRegDetailWin" :maximize="true" :mask-closable="false" @on-close="handleClose"
  ...
  export default {
    ...
    props: {
      ...
      dataGridUrl: {
        type: String,
        default(){
          return "/be/discquote/entrust/discEntrustRegApplyMain/func_queryDiscEntrustRegBillPage";
        }
      },
      batchParams: {
        type: Object,
      ...
      batchUrl: {
        type: String,
        default() {
          return "/be/discquote/entrust/discEntrustRegApplyMain/func_editDiscEntrustReg";
        }
      }
    },
    computed: {
      tempDiscEntrustRegDetailWin: {
        get() {
          return this.discEntrustRegDetailWin;
        },
        set() {
        }
      }
    ...
    methods: {
      ...
      handleClose() {
        ...
        this.$emit("discEntrustRegDetailWinClose", "");
      },
      handleSearch(pageNo) {
        this.$refs.datagrid.selects = [];
        this.$refs.datagrid.selectIds = [];
