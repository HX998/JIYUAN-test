      ...
      <h-col span="24">
        <div>
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item prop="aplStatus" :label="$t('m.i.common.status')">
                  <h-select v-model="formItem.aplStatus" placeholder="">
                    <h-option v-for="item in dERegStatusList" :value="item.key" :key="item.key">{{ item.value }}</h-option>
                  </h-select>
                </h-form-item>
          ...
          <h-datagrid :columns="columns"
                      highlight-row
                      url="/be/discquote/entrust/discEntrustRegMonitorMain/func_queryDiscEntrustRegBatchMonitorPage"
                      :bindForm="formItem"
...
<script>
  ...
  export default {
    name: "discEntrustRegMonitorMain",
    components: {
    ...
    data() {
      return {
        ...
        dataGridUrl: "/be/discquote/entrust/discEntrustRegMonitorMain/func_queryDiscEntrustRegBillPage",
        exportUrl: "/be/discquote/entrust/discEntrustRegMonitorMain/func_exportDiscEntrustRegBill",
        batchUrl: "/be/discquote/entrust/discEntrustRegMonitorMain/func_editDiscEntrustReg"
      };
    },
    mounted() {
