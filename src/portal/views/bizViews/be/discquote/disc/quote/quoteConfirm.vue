      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
              :columns="columns"
              highlightRow
              url="/be/discquote/disc/quote/quoteConfirm/func_getDiscQuoteReplyList"
              :bindForm="formItem"
              :onCurrentChange="handleCurrentChange"
              :onCurrentChangeCancel="handleCurrentChangeCancel"
              ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="quoteApply">{{$t("m.i.common.send")}}</h-button>
  ...
  export default {
    ...
    data(){
      return {
        ...
        brokerBrchCode: "",
        showtrader : false,
        billsUrl: "/be/discquote/disc/quote/quoteConfirm/func_getQuoteBillList",
        batchUrl: "/be/discquote/disc/quote/quoteConfirm/func_getQuoteBatch",
        exportUrl: "/be/discquote/disc/quote/quoteConfirm/func_downloadDiscDelistBill",
        filePathUrl: "/be/discquote/disc/quote/quoteConfirm/"
      }
    },
    mounted() {
        ...
        if (this.currentSelectRow) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let url = "/be/discquote/disc/quote/quoteConfirm/func_cancelApply";
      ...
      quoteApply(){
        if (this.currentSelectRow) {
          this.$hMsgBox.confirm({
            ...
            content: "确定要报价申请吗？",
            onOk: () => {
              let params = {batchId: this.currentSelectRow.id, answerFlag: "0", quoteMode: this.currentSelectRow.quoteMode};
              let url = "/be/discquote/disc/quote/quoteConfirm/func_sendQuoteMsg";
              this.sendPost(params, url);
            }
          });
        } else {
