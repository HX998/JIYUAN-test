      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlight-row
            url="/be/barter/guarntrtrust/guarntrTrustApplAcct/func_queryPendingApplyAcct"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    name: "guarntrTrustApplAcct",
    data() {
      return {
        accountUrl: "/be/barter/guarntrtrust/guarntrTrustApplAcct/func_guarnTrustApplyAcct",
        acctRecord: "/be/barter/guarntrtrust/guarntrTrustApplAcct/func_getGuarnTrustApplyAcctRecord",
        dictMap: new Map(),
        columns: [
          {
            type: "selection",
    ...
    methods: {
      ...
      acctRecordSure(info) {
        ...
        if (list != null && list.length > 0) {
          ...
          post({ idList: ids ,ownedBrchNo:info.ownedBrchNo,licenseFlag:this.licenseFlag}, this.accountUrl).then(res => {
            if (res) {
              let retCode = res.data.retCode;
              if (retCode == "000000") {
      ...
      account() {
        ...
        this.param = { idList: ids ,ownedBrchNo:ownedBrchNo,licenseFlag:this.licenseFlag};
        if(flag){
