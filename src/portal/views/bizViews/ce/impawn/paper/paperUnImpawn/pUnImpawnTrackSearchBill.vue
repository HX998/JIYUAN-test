...
<script>
  ...
  import ImpawnBatchDetail from "@/views/bizViews/ce/impawn/paper/paperUnImpawn/pUnImpawnTrackSearchBatchDetail";
        ...
        },
        {
          ...
          render: (h, params) => {
            if (params.row.unimpawnRgstStatus == null || params.row.unimpawnRgstStatus === "") {
              ...
              let unimpawnRgstStatus = this.getDictValueFromMap(this.impawnBillParams.dictMap, "ImpawnRgstStatus", params.row.unimpawnRgstStatus);
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl = "/ce/impawn/paper/paperUnImpawn/pUnImpawnTrackSearch/func_billlist";
          this.$nextTick(() => {
