...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/paper/paperUnImpawn/pUnImpawnAccountMain/func_list"
            :bindForm="formItem"
    ...
    <impawn-account-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                         @returnAccountMain="returnAccountMain"></impawn-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "pUnImpawnAccountMain",
    components: {
      ImpawnAccountBill:()=>import(/* webpackChunkName: "ce/impawn/paper/paperUnImpawn/pUnImpawnAccountBill" */`@/views/bizViews/ce/impawn/paper/paperUnImpawn/pUnImpawnAccountBill`),
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.impawnBillParams.detailType = "pUnImpawnAccount";
        this.mainVue = false;
