      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/paper/paperUnImpawn/pUnImpawnApplyMain/func_list"
            :bindForm="formItem"
        ...
        <!-- 新增修改弹窗 -->
        <p-un-impawn-apply-add :impawnAddOrEditWin="impawnAddOrEditWin" :batchParams="batchParams"
                               @impawnAddOrEditWinClose="impawnAddOrEditWinClose" :licenseFlag="this.licenseFlag"></p-un-impawn-apply-add>
      </h-col>
    </h-row>
...
<script>
  ...
  export default {
    name: "pUnImpawnApplyMain",
    components: {
      PUnImpawnApplyAdd:()=>import(/* webpackChunkName: "ce/impawn/paper/paperUnImpawn/pUnImpawnApplyAdd" */`@/views/bizViews/ce/impawn/paper/paperUnImpawn/pUnImpawnApplyAdd`),
    ...
    methods: {
      ...
      handleDel() {
        ...
        post({ id: id ,deleteFlag:"0" }, "/ce/impawn/paper/paperUnImpawn/pUnImpawnApplyMain/func_deleteBatch").then(res => {
          if (res) {
            let retCode = res.data.retCode;
      ...
      continueApply(id){
          let url= "/ce/impawn/paper/paperUnImpawn/pUnImpawnApplyMain/func_deleteBatch";
