...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/paper/paperUnImpawn/pUnImpawnCancelAccountMain/func_list"
            :bindForm="formItem"
    ...
    <p-un-impawn-cancel-account-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                                @returnCancelAccountMain="returnCancelAccountMain"></p-un-impawn-cancel-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "pUnImpawnCancelAccountMain",
    components: {
      PUnImpawnCancelAccountBill:()=>import(/* webpackChunkName: "ce/impawn/paper/paperUnImpawn/pUnImpawnCancelAccountBill" */`@/views/bizViews/ce/impawn/paper/paperUnImpawn/pUnImpawnCancelAccountBill`),
