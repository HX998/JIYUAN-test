...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_queryImpawnBatch"
            :bindForm="formItem"
    ...
    <p-impawn-account-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                         @returnAccountMain="returnAccountMain"></p-impawn-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "pImpawnAccountMain",
    components: {
      PImpawnAccountBill:()=>import(/* webpackChunkName: "ce/impawn/paper/paperImpawn/pImpawnAccountBill" */`@/views/bizViews/ce/impawn/paper/paperImpawn/pImpawnAccountBill`),
