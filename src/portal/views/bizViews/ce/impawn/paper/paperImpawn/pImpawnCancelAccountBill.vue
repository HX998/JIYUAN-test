  ...
  export default {
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl =  "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_pageQueryCancelAcctFlow";
          this.$nextTick(() => {
    ...
    methods: {
      ...
      handleAccountBack(params) {
        let url = "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_cancelimpawnAccount";
      ...
      accountBillDetail() {
        ...
        this.dataDetailUrl =  "/ce/impawn/paper/paperImpawn/pImpawnCancelAccountMain/func_pageQueryImpawnBillList";
