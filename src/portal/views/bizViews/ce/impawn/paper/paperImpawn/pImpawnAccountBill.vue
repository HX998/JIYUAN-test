            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="billManagerFormItem" :label-width="90" ref="billManagerFormItem" cols="4"
                ...
                <h-form-item :label="$t('m.i.billInfo.billMoney')" prop="billMoney">
                  <h-typefield type="money" v-model="billManagerFormItem.billMoney"  bigTips placeholder=""></h-typefield>
                </h-form-item>
...
<script>
  ...
  import ImpawnBatchDetail from "@/views/bizViews/ce/impawn/paper/paperImpawn/pImpawnAccountBatchDetail";

  export default {
    name: "pImpawnAccountBill",
    components: {
      ImpawnBatchDetail,
    },
    data() {
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl = "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_pageQueryImpawnBillList";
          this.$nextTick(() => {
    ...
    methods: {
      ...
      handleSearch() {
        ...
        // this.billManagerFormItem.billMoney = this.billManagerFormItem.billMoney.replace(/,/g, "");
      ...
      //获取分录信息
      getEntryInfo(params) {
        this.acctRecordUrl =  "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_getImpawnAccount" ;
      ...
      acctSubmitSure(info) {
        ...
        let url =  "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_impawnAccount";
      ...
      acctAuthorize(){
        ...
        this.acctSubmitFlag = true;
        let url =  "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_addAcctAuthorize" ;
        post(params, url).then(res => {
          this.acctSubmitFlag = false;
          if (res) {
            let msg = res.data.retMsg;
      ...
      handleAccountBack(params) {
        let url =  "/ce/impawn/paper/paperImpawn/pImpawnAccountMain/func_impawnAccountBack";
        this.$hMsgBox.confirm({
          title: this.$t("m.i.common.confirm"),
          content: "确定记账退回吗",
          onOk: () => {
