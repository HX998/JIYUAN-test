...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_list"
            :bindForm="formItem"
    ...
    <e-un-impawn-account-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                         @returnAccountMain="returnAccountMain"></e-un-impawn-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "eUnImpawnAccountMain",
    components: {
      EUnImpawnAccountBill:()=>import(/* webpackChunkName: "ce/impawn/elec/elecUnImpawn/eUnImpawnAccountBill" */`@/views/bizViews/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountBill`),
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.impawnBillParams.detailType = "eUnImpawnAccount";
        this.mainVue = false;
