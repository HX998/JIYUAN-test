...
<script>
  ...
  import ImpawnBatchDetail from "@/views/bizViews/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountBatchDetail";

  export default {
    name: "eUnimpawnAccountBill",
    components: {
      ImpawnBatchDetail
    },
    data() {
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl =  "/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_billlist";
          this.$nextTick(() => {
    ...
    methods: {
      ...
      //获取分录信息
      getEntryInfo(params) {
        this.acctRecordUrl =  "/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_getUnImpawnAccount";
      ...
      acctSubmitSure(info) {
        ...
        let url =  "/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_unImpawnAccount";
      ...
      acctAuthorize(){
        ...
        this.acctSubmitFlag = true;
        let url =  "/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_addAcctAuthorize" ;
        post(params, url).then(res => {
          this.acctSubmitFlag = false;
          if (res) {
            let msg = res.data.retMsg;
      ...
      handleAccountBack(params) {
        let url =  "/ce/impawn/elec/elecUnImpawn/eUnImpawnAccountMain/func_unImpawnAccountBack";
        this.$hMsgBox.confirm({
          title: this.$t("m.i.common.confirm"),
          content: "确定记账退回吗",
          onOk: () => {
