...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/ce/impawn/elec/elecImpawn/eImpawnCancelAccountMain/func_queryImpawnBatch"
            :bindForm="formItem"
    ...
    <e-impawn-cancel-account-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                                @returnCancelAccountMain="returnCancelAccountMain"></e-impawn-cancel-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "eImpawnCancelAccountMain",
    components: {
      EImpawnCancelAccountBill:()=>import(/* webpackChunkName: "ce/impawn/elec/elecImpawn/eImpawnCancelAccountBill" */`@/views/bizViews/ce/impawn/elec/elecImpawn/eImpawnCancelAccountBill`),
