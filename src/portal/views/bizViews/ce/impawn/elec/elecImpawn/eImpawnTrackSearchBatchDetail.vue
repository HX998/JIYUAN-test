...
<!--          <h-col span="8">-->
<!--            <h-row>-->
<!--              <h-col span="9" class="label">{{$t('m.i.billInfo.billOrigin')}}：</h-col>-->
<!--              <h-col span="15" class="val">{{ formatBillOrigin }}</h-col>-->
<!--            </h-row>-->
<!--          </h-col>-->
          <h-col span="8">
            <h-row>
        ...
        <h-row :gutter="8">
          ...
          <h-col span="8">
            <h-row>
              <h-col span="9" class="label">{{$t('m.i.ce.collectionAccount')}}：</h-col>
              <h-col span="15" class="val">{{ viewDetailForm.reserve1}}</h-col>
            </h-row>
          </h-col>
        </h-row>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getImpawnBatchInfo(optType,isAudit) {
        ...
        let url =  "/ce/impawn/elec/elecImpawn/eImpawnTrackSearch/func_getImpawnBatchInfo";
        post(params, url).then(res => {
          if (res) {
            ...
            if (retCode === "000000") {
              ...
              this.viewDetailForm.reserve1 = res.data.retData.reserve1;
            } else {
