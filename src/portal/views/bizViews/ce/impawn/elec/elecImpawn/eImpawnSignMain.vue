...
<!--                </h-form-item>-->
          ...
          <h-datagrid :columns="columns"
                      highlightRow
                      url="/ce/impawn/elec/elecImpawn/eImpawnSignMain/func_queryImpawnBatch"
                      :bindForm="formItem"
                      :onCurrentChange="handleCurrentChange"
                      :onCurrentChangeCancel="handleCurrentChangeCancel"
                      ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="elecSign()">签收</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    </h-row>
    <e-impawn-sign-bill :billManagerVue="billManagerVue" :impawnBillParams="impawnBillParams"
                        :btnAuth="childrenBtnAuth" @returnSignMain="returnSignMain"></e-impawn-sign-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "eImpawnSignMain",
    components: {
      EImpawnSignBill:()=>import(/* webpackChunkName: "ce/impawn/elec/elecImpawn/eImpawnSignBill" */`@/views/bizViews/ce/impawn/elec/elecImpawn/eImpawnSignBill`),
    ...
    methods: {
      ...
      //签收
      elecSign() {
        if(this.btnAuth.impawnSign!=null||this.btnAuth.impawnSign!=undefined){
          this.childrenBtnAuth = this.btnAuth.impawnSign.children;
        }
