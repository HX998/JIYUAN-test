...
<!--                </h-form-item>-->
          ...
          <h-datagrid :columns="billManagerColumns"
                      url="/ce/impawn/elec/elecImpawn/eImpawnSignMain/func_pageQueryImpawnBillList"
                      highlightRow
                      :auto-load="false"
            ...
            <div slot="toolbar" class="pull-left">
              <h-dropdown placement="bottom-start" @on-click="signBack">
                <h-button type="primary" v-if="this.btnAuth.reCheckBack === undefined ? true : this.btnAuth.reCheckBack.isShow">退回
...
<script>
  ...
  import ImpawnBatchDetail from "@/views/bizViews/ce/impawn/elec/elecImpawn/eImpawnSignBatchDetail";

  export default {
    name: "eImpawnSignBill",
    components: {
      ImpawnBatchDetail
    },
    data() {
    ...
    methods: {
      ...
      handleBackSubmit(params, signType, type) {
        ...
        let url = signType === "back" ? "/ce/impawn/elec/elecImpawn/eImpawnSignMain/func_impawnSignBack" : "/ce/impawn/elec/elecImpawn/eImpawnSignMain/func_submmitImpawnSign";
