...
<script>
  ...
  import ImpawnBatchDetail from "@/views/bizViews/ce/impawn/elec/elecImpawn/eImpawnTrackSearchBatchDetail";
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl =  "/ce/impawn/elec/elecImpawn/eImpawnTrackSearch/func_pageQueryImpawnBillList";
          this.$nextTick(() => {
