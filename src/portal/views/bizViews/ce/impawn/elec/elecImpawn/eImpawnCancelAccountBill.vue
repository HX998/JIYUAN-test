  ...
  export default {
    ...
    watch: {
      billManagerVue(val) {
        if (val) {
          ...
          this.dataUrl =  "/ce/impawn/elec/elecImpawn/eImpawnAccountMain/func_pageQueryCancelAcctFlow";
          this.$nextTick(() => {
    ...
    methods: {
      ...
      handleAccountBack(params) {
        let url = "/ce/impawn/elec/elecImpawn/eImpawnAccountMain/func_cancelimpawnAccount";
      ...
      accountBillDetail() {
        ...
        this.dataDetailUrl =  "/ce/impawn/elec/elecImpawn/eImpawnCancelAccountMain/func_pageQueryImpawnBillList";
