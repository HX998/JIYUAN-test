      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlight-row
            url="/ce/recourse/elecRecourseReply/recourseReplyRevoke/func_queryCancelableAgreement"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="recourseReplyRevoke()" v-if="authObj.recourseReplyRevokeAuth">撤回
              </h-button>
            </div>
          </h-datagrid>
        </div>
...
<script>
  ...
  export default {
    name: "recourseReplyRevoke",
    data() {
      return {
        ifShowMore : false,
        //给按钮增加权限
        authObj : {
          recourseReplyRevokeAuth: true           //同意清偿撤回
        },
        columns : [
          {
            type: "radio",
    ...
    methods: {
      ...
      handleRevoke() {
        ...
        let params = {
          recourseId: this.currentSelectRow.id,
        ...
        post(params, "/ce/recourse/elecRecourseReply/recourseReplyRevoke/func_cancelAgreementRecourseEcdsRequest").then(res => {
          if (res) {
