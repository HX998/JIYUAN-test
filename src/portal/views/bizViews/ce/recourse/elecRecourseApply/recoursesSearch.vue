...
<template>
  <h-msg-box v-model="tempRecoursesWin" width="1100" :mask-closable="false" @on-close="handleClose" top="10"
    ...
    <h-datagrid
      :columns="columns"
      highlight-row
      url="/ce/recourse/elecRecourseApply/recoursesSearch/func_queryRecourseAbledInfo"
      :bindForm="formItem"
      ...
      showRecoursesWin(val) {
        if (val === true) {
          this.$nextTick(() => {
            ...
            this.formItem.ecdsBillStatus = this.recoursesParam.ecdsBillStatus;
