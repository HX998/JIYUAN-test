      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlight-row
            url="/ce/recourse/elecRecourseApply/recourseReplyAgree/func_queryStaySignUpDraft"
            :bindForm="formItem"
      ...
      recourseReply() {
        ...
        if (this.currentSelectRow != null && this.currentSelectRow.length !== 0) {
          ...
          this.$nextTick(() => {
            ...
            this.addForm.recourseId = this.currentSelectRow.id;
      ...
      submitForm() {
        this.$refs["addForm"].validate(valid => {
          if (valid) {
            ...
            let url = "/ce/recourse/elecRecourseApply/recourseReplyAgree/func_agreementRecourseSignUpEcdsRequest";
