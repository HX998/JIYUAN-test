<template>
  ...
  <div class="layout">
    <h-row name="flex" class="layout-menu-wrapper">
      <h-col span="24">
        <div v-if="esDiscCancelAccountBatchMain" key="1">
          <div>
            <!--查询表单-->
            <div class="h-form-search-box">
              ...
              <h-datagrid
                ...
                highlight-row
                :bindForm="formItem"
                url="/ce/disc/elec/account/ediscCancelAccountBatchMain/func_pageQueryDiscBatchList"
        ...
        <div v-if="discCancelAccountBillMain" key="2">
          ...
          <h-datagrid
            ...
            url="/ce/disc/elec/account/eldiscCancelAccountBatchMain/func_pageQueryCancelAcctFlow"
            :row-select="true"
          ...
          <h-msg-box v-model="billDetailSearchWin" width="800"  class="h-form-table-layer"
            ...
            <h-datagrid
              ...
              url="/ce/disc/elec/account/electricDiscCancelAccountBatchMain/func_pageQueryCeDiscBillList"
              ref="billDatagrid">
            </h-datagrid>
            <!-- 弹出框模式底部按钮 -->
            <div slot="footer">
...
<script>
  import { post, on, off ,getDictListByGroups,formatNumber,formatBillRange, getDictValueFromMap,getSingleParamValuesByKeys,accMul} from "@/api/bizApi/commonUtil";
  import {deepClone} from "@/utils/index";

  export default {
    name: "esDiscCancelAccountBatchMain",
    components: {
    ...
    data() {
      ...
      return {
        ...
        isList : [],
        dictMap : new Map(),
        esDiscCancelAccountBatchMain : true,
    ...
    mounted() {
      getDictListByGroups("DraftTypeCode,PayType,CorpScale,Yon,DiscRgstStatus,AssetIndustry,BillOrigin").then(res => {
    ...
    methods: {
      ...
      handleForm() {
        ...
        this.esDiscCancelAccountBatchMain = false;
      ...
      returnBack() {
        ...
        this.esDiscCancelAccountBatchMain = true;
        this.$nextTick(() => {
      ...
      cancelAccountSelect(){
        ...
        this.$hMsgBox.confirm({
          ...
          content: "确定选择撤销记账吗?",
          onOk: () => {
            post({batchId : this.discBatchId , operType:"0" , foreFlowNos:ids}, "/ce/disc/elec/account/electricDiscCancelAccountBatchMain/func_cancelDiscAccount").then(res => {
              if(res) {
      ...
      handleAccountBatch() {
        ...
        post({ batchId : this.discBatchId , operType:"1" }, "/ce/disc/elec/account/electricDiscCancelAccountBatchMain/func_cancelDiscAccount").then(res => {
          if (res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            if (retCode === "000000") {
