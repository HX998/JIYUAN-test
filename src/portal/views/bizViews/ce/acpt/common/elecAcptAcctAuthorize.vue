  ...
  <div>
    ...
    <div v-if="isShow">
      <h-datagrid
        ...
        url="/ce/acpt/elec/account/eAcptAccountMain/func_queryPageAcptAcctAuthBill"
...
export default {
    ...
    mounted() {
      getDictListByGroups("AcptType,GuarntrType,Yon,BillOrigin").then(res => {
    ...
    props: {
      ...
      queryBatchUrl: {
        type: String,
        default() {
          return "ce/acpt/elec/account/eAcptAccountMain/func_getAcptBatchByQueryDto";
        }
      }
    },
    methods: {
      ...
      //记账
      account() {
        this.acctRecordUrl = "/ce/acpt/elec/account/eAcptAccountMain/func_generateAcctAuthRecord";
      ...
      acctSubmitSure(info) {
        ...
        post(param, "/ce/acpt/elec/account/eAcptAccountMain/func_acctAuthorizePass").then(res => {
      ...
      submitCancelAccount(){
        ...
        post(param, "/ce/acpt/elec/account/eAcptAccountMain/func_cancelAcctAuthorizePass").then(res => {
          if(res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            debugger
      ...
      submitAcctAuthorizeBack(){
        ...
        post(param, "/ce/acpt/elec/account/eAcptAccountMain/func_acctAuthorizeReturn").then(res => {
          if(res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            if (retCode === "000000") {
