  ...
  <div>
    ...
    <div v-if="isShow">
      <h-datagrid
        ...
        url="/ce/acpt/paper/backUnused/backUnusedMain/func_queryPageAcptAcctAuthBill"
...
<script>
  ...
  export default {
    name: "paperBackUnusedAcptAcctAuthorize",
    components: {
    ...
    mounted() {
      getDictListByGroups("AcptType,DraftTypeCode,Yon,RiskStatus").then(res => {
    ...
    props: {
      ...
      querySumUrl: {
        type: String,
        default() {
          return "ce/acpt/paper/backUnused/backUnusedMain/func_queryPageAcptAcctAuthBill";
        }
      }
    },
    methods: {
      getSumInfo() {
        //获取批次详细信息
        post({ids: this.listIds, curFuncNo:"PICE010516", billClass:"ME01"}, this.querySumUrl).then(res => {
          if (res) {
      ...
      //记账
      account() {
        this.acctRecordUrl = "/ce/acpt/paper/backUnused/backUnusedAccount/func_generateAcctRecord";
        this.acctRecordParam = {ids: this.listIds}
        this.showAcctRecordWin = true;
      },
      //确定记账
      acctSubmitSure(info) {
        let param = {};
        param = {id:this.id,batchId: this.batchId,ids: this.listIds,isBack: "0",isAllDataOneBatch:"1",curFuncNo:"PICE010516"};
        this.acctSubmitFlag = true;
        post(param, "/ce/acpt/paper/backUnused/backUnusedAccount/func_acctAuthorizePass").then(res => {
      ...
      submitAcctAuthorizeBack(){
        let param = {};
        param = {id:this.id,batchId: this.batchId, ids: this.listIds,curFuncNo:"PICE010516"};
