  ...
  <div>
    ...
    <div v-if="isShow">
      <h-datagrid
        ...
        url="/ce/acpt/elec/paymentDue/ePaymentAccountMain/func_queryPageAcptAcctAuthBill"
...
<script>
  ...
  export default {
    ...
    mounted() {
      getDictListByGroups("AcptType,GuarntrType,Yon,RiskStatus,SettlementMarkCode,DraftTypeCode").then(res => {
    ...
    props: {
      ...
      querySumUrl: {
        type: String,
        default() {
          return "ce/acpt/elec/paymentDue/ePaymentAccountMain/func_queryPageAcptAcctAuthBill";
        }
      }
    },
    methods: {
      ...
      acctSubmitSure(info) {
        ...
        post(param, "/ce/acpt/elec/paymentDue/ePaymentAccountMain/func_acctAuthorizePass").then(res => {
      ...
      submitAcctAuthorizeBack(){
        ...
        post(param, "/ce/acpt/elec/paymentDue/ePaymentAccountMain/func_acctAuthorizeReturn").then(res => {
          if(res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            if (retCode === "000000") {
