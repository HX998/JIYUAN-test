...
export default {
    ...
    created(){
      ...
      getConnectMode().then(res=>{
        this.mode = res;
        // if (this.mode==="2") {
        //   this.acctRecordUrl="/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_getAcctFlow";
        //   this.accountUrl="/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_accountPayment";
        //   this.queryBillUrl="/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_prsttnQueryPaymentApplyNeedResp";
        //   this.formItem.order="APPL_DT,id asc";
        // }else {
          this.acctRecordUrl = "/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_accountFlow";
          this.accountUrl="/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_accountInCore";
          this.queryBillUrl = "/ce/acpt/innerBillPayment/innerBillPaymentAccount/func_queryPaymentApplyNeedResp";
    ...
    methods: {
      ...
      getEntryInfo() {
        ...
        this.acptIds = ids;
        this.acctRecordParam = {ids: this.acptIds,billType:this.formItem.billType,ownedBrchNo:this.formItem.ownedBrchNo,licenseFlag:this.licenseFlag};
        this.showAcctRecordWin = true;
      },
      //确定记账
      acctSubmitSure(info) {
        this.acctSubmitFlag = true;
        let obj={ids: this.acptIds,idList: this.acptIds,billType:this.formItem.billType,ownedBrchNo:this.formItem.ownedBrchNo,licenseFlag:this.licenseFlag};
        if (this.mode==='1'){
