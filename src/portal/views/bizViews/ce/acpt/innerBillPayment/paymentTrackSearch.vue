...
export default {
    ...
    data() {
      return {
        ...
        formItem: {
          ...
          billStatus:'',
          duePayDtRange: [],
          order:'ACPT_PROTOCAL_NO desc,REMIT_DT desc ,ID',
          minRemitDt:"",
          maxRemitDt:"",
          minDueDate:"",
          maxDueDate:"",
          ...
          },
          {
            ...
            render:(h, params)=>{
              if(params.row.acptAcctStatus === null || params.row.acptAcctStatus === "" || params.row.acptAcctStatus.substring(5, 6) === "n"){
                ...
                let list = getDictValueFromMap(this.dictMap, "AcctFlag", params.row.acptAcctStatus.substring(5,6));
                return h("span",
                  {
                    domProps: {
                      title: list
    ...
    created(){
      ...
      getConnectMode().then(res=>{
        this.mode = res;
        // if (this.mode==="2") {
        //   this.queryBillUrl="/ce/acpt/innerBillPayment/paymentTrackSearch/func_prsttnQueryPaymentApplyNeedRespForTrack";
        //   this.downLoadUrl="/ce/acpt/innerBillPayment/paymentTrackSearch/func_prsttnExportDataForPayment"
        //   this.queryUrl="/ce/acpt/innerBillPayment/paymentTrackSearch/func_prsttnQueryCorpPaymentCount"
        // }else {
          this.queryBillUrl = "/ce/acpt/innerBillPayment/paymentTrackSearch/func_queryPaymentApplyNeedRespForTrack";
          this.downLoadUrl="/ce/acpt/innerBillPayment/paymentTrackSearch/func_exportDataForPayment";
          this.queryUrl= "/ce/acpt/innerBillPayment/paymentTrackSearch/func_queryPaymentApplyNeedRespForTrack"   //总笔数总金额URL
        // }
        this.$nextTick(()=>{
          // if (this.mode==="1"){
    ...
    mounted() {
      getDictListByGroups("DraftTypeCode,CDMedia,RiskStatus,AcctFlag,BarterTrustStatus,PrsttnSignStatus,BillOrigin").then(res => {
    ...
    methods: {
      ...
      exportExcel() {
        if (this.mode==="1"){
          this.param = 'prsttnTrackSearchExportInfo';
        }else{
          this.param = 'prsttnTrackSearchExportInfo_2';
        }
