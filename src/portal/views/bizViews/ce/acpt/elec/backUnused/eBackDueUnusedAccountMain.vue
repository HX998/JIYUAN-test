      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      highlightRow
                      url="/ce/acpt/elec/backUnused/eBackDueUnusedAccountMain/func_dueUnusedBackQuery"
                      :bindForm="formItem"
                      :row-select="true"
                      :has-select="false"
                      ref="datagrid">
...
<script>
  ...
  export default {
    name: "eBackDueUnusedAccountMain",
    components: {
    ...
    methods:{
      ...
      //获取分录信息
      getEntryInfo() {
        this.acctRecordUrl = "/ce/acpt/elec/backUnused/eBackDueUnusedAccountMain/func_generateAcctRecord";
      ...
      acctSubmitSure(info) {
        ...
        post({ids: this.acptIds,licenseFlag:this.licenseFlag,ownedBrchNo: this.$refs.datagrid.selects[0].ownedBrchNo}, "/ce/acpt/elec/backUnused/eBackDueUnusedAccountMain/func_dueUnusedBackSubmitAcct").then(res => {
