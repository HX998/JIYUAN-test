      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/elec/backUnused/eNoRefundAgainRefundMain/func_pageQueryAcptBillReturnFee"
                      :bindForm="formItem"
                      ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="refund" :disabled="formItem.isReturnIssueFee === '1'">退费</h-button>
            </div>
          </h-datagrid>
        </div>
        <!-- 查询客户信息弹窗 -->
    ...
    methods: {
      ...
      refund() {
        ...
        this.$hMsgBox.confirm({
          ...
          content: "确定退费吗?",
          onOk: () => {
            post({ids: ids,licenseFlag:this.licenseFlag,ownedBrchNo: ownedBrchNo}, "/ce/acpt/elec/backUnused/eNoRefundAgainRefundMain/func_acptDrwgBackRefundsApply").then(res => {
              if(res) {
