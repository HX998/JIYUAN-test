...
export default {
    name: "eBackUnusedAccReplaceMain",
    components: {
    ...
    methods: {
      ...
      account() {
        ...
        this.$hMsgBox.confirm({
          ...
          content: "请确认并检查票号["+billNoStr+"]，是否已发起提示收票且收票人已完成签收操作，若已完成则不允许未用退回操作！",
          onOk: () => {
            this.getEntryInfo();
          }
        });
      ...
      //获取分录信息
      getEntryInfo() {
        this.acctRecordUrl = "/ce/acpt/elec/backUnused/eBackUnusedAccountMain/func_generateAcctRecord";
      ...
      acctSubmitSure(info) {
        ...
        post({ids: this.acptIds, isBack: "0",licenseFlag:this.licenseFlag,ownedBrchNo: this.$refs.datagrid.selects[0].ownedBrchNo}, "/ce/acpt/elec/backUnused/eBackUnusedAccountMain/func_acptDrwgBackAcct").then(res => {
