      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/elec/freeze/freezeRegCheck/func_queryFreezeRegCheckByPage"
                      :bindForm="formItem"
                      ref="datagrid">
  ...
  export default {
    ...
    data() {
      return {
        ...
        // 查看附件
        showFileWin: false,
        filePathUrl: "/ce/acpt/elec/freeze/freezeRegCheck/",
        fileBatchParams: {},
        // 退回原因
    ...
    methods: {
      ...
      recheckPass() {
        ...
        let url = "/ce/acpt/elec/freeze/freezeRegCheck/func_checkPassFreezeRegApply";
      ...
      //退回确认
      recheckBackSubmit() {
        let url = "/ce/acpt/elec/freeze/freezeRegCheck/func_checkRejectFreezeRegApply";
        this.sendPost(this.recheckForm, url);
      },
      //提交请求
      sendPost(params, url) {
