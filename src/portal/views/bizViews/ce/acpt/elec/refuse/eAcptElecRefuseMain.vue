      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/elec/refuse/eAcptElecRefuseMain/func_queryPageRefuseBillInfo"
                      :bindForm="formItem"
                      :param-id="paramId"
                      ref="datagrid">
           ...
           title: this.$t("m.i.ce.otherBankAcptMark"),
            ...
            render: (h, params) => {
              if (params.row.platformFlag == null || params.row.platformFlag === "") {
                return h("span", "");
              } else if (params.row.platformFlag === "2"){
                return h("span", "否");
      ...
      post({authPath:this.$route.path}, "sm/auth/licenseBrch/focusOper/func_checkLicenseAuth").then(res => {
        if (res) {
          ...
          if (retCode === "000000") {
            ...
            if (this.licenseFlag) {
              this.$refs.datagrid.controlColumnsHidden("transToBankName", false);
            }else {
              this.$refs.datagrid.controlColumnsHidden("transToBankName", true);
            }
          } else {
    ...
    methods: {
      ...
      refuse() {
        ...
        this.$hMsgBox.confirm({
          ...
          content: '确定拒绝吗？',
          onOk: () => {
              post({transIds: transIds}, "/ce/acpt/elec/refuse/eAcptElecRefuseMain/func_refuseBillInfo").then(res => {
