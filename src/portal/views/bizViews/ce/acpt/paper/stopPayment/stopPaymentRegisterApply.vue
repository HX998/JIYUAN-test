      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_sspdReg"
                      :bindForm="formItem"
                      ref="datagrid">
...
export default {
    ...
    data() {
      return {
        ...
        formItem: {
          ...
          billType: '',
          billNo: '',
          acptRgstStatusList:'1-BTA04,4-BTA04,2-BTA05,2-BTA04',
          acptProtocalNo: '',
        ...
        imageParams: {
          ...
          imgTypeList:[],
          imgBusiType:"2",
          imageUrl:"/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_imageListPage", //查询可查看影像url
          imageUploadUrl:"/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_uploadImage", //影像上传url
          imageRegisterUrl:"/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_rgstImage", //影像登记url
          imageDeleteUrl:"/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_deleteImage", //影像删除url
          imgShowUrl:"/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_imageById?id=", //查看影像url
          busiType:"RI04",
          licenseFlag:"",
          ownedBrchNo:""
        }
    ...
    methods: {
      ...
      register() {
        ...
        post({idList: ids,billIdList:billIdList, busiType: '1',licenseFlag:this.licenseFlag,ownedBrchNo:this.$refs.datagrid.selects[0].ownedBrchNo}, "/ce/acpt/paper/stopPayment/stopPaymentRegisterApply/func_register").then(res => {
          if(res) {
