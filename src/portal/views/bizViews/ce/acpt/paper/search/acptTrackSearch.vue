          ...
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item prop="promNoteNoLike" :label="$t('m.i.billInfo.promNoteNo')">
...
export default {
    ...
    mounted() {
      getDictListByGroups("AcptType,SspdStatus,AcctFlag,AcptStatus,DraftTypeCode,AcptCpesRgstType,AcptRgstStatus,DeductStatusType").then(res => {
        ...
        this.sspdStatusList = this.sspdStatusList.filter(item => item.key === "0" || item.key === "1" || item.key === "3" || item.key === "4" || item.key === "6");
