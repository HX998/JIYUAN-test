      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/paper/paymentDue/acptSettleRegisterCancel/func_query"
                      :bindForm="formItem"
                      ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="cancle" >{{$t('m.i.ce.rgstCancel')}}</h-button>
            </div>
          </h-datagrid>
        </div>
        <!-- 查询客户信息弹窗 -->
...
export default {
    ...
    data() {
      return {
        ...
        formItem: {
          ...
          minDueDt: "",
          maxDueDt: "",
          curFuncNo : 'PICE011004',
          acptRgstStatusList : ['3-BTA04','3-BTA10'],
          acptRgstDt:window.sessionStorage.getItem("workDate"),
          billClass: 'ME01',
          reverseBillNo:''
        },
        formItemRemitDt: "",
    ...
    methods: {
      ...
      cancle() {
        ...
        post({ids: ids}, "/ce/acpt/paper/paymentDue/acptSettleRegisterCancel/func_back").then(res => {
          if (res) {
