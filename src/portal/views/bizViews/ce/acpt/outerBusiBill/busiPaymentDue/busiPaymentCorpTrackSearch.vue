          ...
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <bill-no :label="$t('m.i.billInfo.billNo')"  v-model="formItem.reverseBillNo" prop="reverseBillNo"></bill-no>
            ...
            <h-panel class="h-form-search-box clearfix">
              <h-form :label-width="90" class="h-form-search" cols="4">
                <div class="h-search-form-row">
                  <h-form-item :label="$t('m.i.billInfo.sumMoney')">
...
<script>
  ...
  export default {
    name: "busiPaymentCorpTrackSearch",
    components: {
      ...
      return {
        ...
        autmentColumns:[
          ...
          },
          {
            ...
            hiddenCol: false,
            render: (h, params) => {
              let list = this.getDictValueFromMap(this.dictMap, "AcctFlag", params.row.deductStatus);
              return h("span",
                {
                  domProps: {
                    title: list
          ...
          {
            title: this.$t("m.i.ce.deductErrorReason"),
            key: "deductErrorReason",
            ellipsis: false,
            hiddenCol: false,
          },
          {
            title: this.$t("m.i.ce.signErrorReason"),
            key: "signErrorReason",
            ellipsis: false,
            hiddenCol: false,
          }
    ...
    methods: {
      ...
      //导出
      exportExcel() {
        this.param = 'busiPrsttnCorpTrackSearchExportInfo';
