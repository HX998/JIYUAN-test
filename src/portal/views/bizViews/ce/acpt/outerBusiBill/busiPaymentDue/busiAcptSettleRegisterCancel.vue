      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      highlightRow
                      url="/ce/acpt/outerBusiBill/busiPaymentDue/busiAcptSettleRegisterCancel/func_pageQueryAcptCorpList"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
...
export default {
    name: "busiAcptSettleRegisterCancel",
    data() {
      return {
        formItem: {
          billNoLike: '',
          acptSettleRgstStatusList: 'BTA04,BTA10',
          acptSettleRgstDt:window.sessionStorage.getItem("workDate"),
          reverseBillNo: ''
        },
        columns: [
          {
    ...
    methods: {
      ...
      handleBack() {
        ...
        post({ ids: ids }, "/ce/acpt/outerBusiBill/busiPaymentDue/busiAcptSettleRegisterCancel/func_cancelAcptCorpSettleCheck").then(res => {
          if (res) {
