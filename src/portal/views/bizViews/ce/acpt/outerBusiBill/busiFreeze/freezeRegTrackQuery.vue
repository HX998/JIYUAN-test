      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/outerBusiBill/busiFreeze/freezeRegTrackQuery/func_freezeRegTrackQueryByPage"
                      :bindForm="formItem"
                      ref="datagrid">
  ...
  export default {
    ...
    data() {
      return {
        ...
        // 查看附件
        showFileWin: false,
        filePathUrl: "/ce/acpt/outerBusiBill/busiFreeze/freezeRegTrackQuery/",
        fileBatchParams: {},
        //清单导出
        exportParam: "",
        exportRows: "",
    ...
    methods: {
      ...
      //清单导出
      listExport() {
        this.exportParam = "busiFreezeRegTrackQueryExportInfo";
      ...
      exportList(field, exportType) {
        let url = window.LOCAL_CONFIG.API_HOME + "/ce/acpt/outerBusiBill/busiFreeze/freezeRegTrackQuery/func_exportFreezeRegTrackQueryList";
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
