      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/outerBusiBill/busiFreeze/freezeRegAcct/func_queryFreezeRegAcctByPage"
                      :bindForm="formItem"
                      ref="datagrid">
  ...
  export default {
    ...
    data() {
      return {
        ...
        // 查看附件
        showFileWin: false,
        filePathUrl: "/ce/acpt/outerBusiBill/busiFreeze/freezeRegAcct/",
        fileBatchParams: {},
        columns: [
          {
            type: 'selection',
        ...
        // 记账
        acctRecordParam: {},
        acctRecordUrl:"/ce/acpt/outerBusiBill/busiFreeze/freezeRegAcct/func_queryFreezeRegAcctRecord",
    ...
    methods: {
      ...
      acctSubmitSure(info) {
        ...
        let url = "/ce/acpt/outerBusiBill/busiFreeze/freezeRegAcct/func_freezeRegAcct";
