      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_queryUnSspdRegister"
                      :bindForm="formItem"
                      ref="datagrid">
...
export default {
    name: "busiCancelStopPaymentRegisterApply",
    components: {
    },
    data() {
      return {
        ...
        imageParams: {
          ...
          imgTypeList:[],
          imgBusiType:"2",
          imageUrl:"/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_imageListPage", //查询可查看影像url
          imageUploadUrl:"/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_uploadImage", //影像上传url
          imageRegisterUrl:"/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_rgstImage", //影像登记url
          imageDeleteUrl:"/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_deleteImage", //影像删除url
          imgShowUrl:"/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_imageById?id=", //查看影像url
          busiType:"RI05"
        }
      }
    },
    ...
    methods: {
      ...
      register() {
        ...
        post({idList: ids, billIdList: billIds,busiType: '2'}, "/ce/acpt/outerBusiBill/busiStopPayment/busiCancelStopPaymentRegisterApply/func_register").then(res => {
          if(res) {
