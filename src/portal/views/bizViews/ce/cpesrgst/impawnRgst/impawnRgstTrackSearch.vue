      ...
      <h-col span="24">
        <div>
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item :label="$t('m.i.billInfo.billNo')" prop="billNoLike">
                  <h-input v-model="formItem.billNoLike" placeholder="" :maxlength="16"></h-input>
                </h-form-item>
                <h-form-item prop="transFromNameLike" :label="$t('m.i.ce.pledgorName')">
                  <h-input v-model="formItem.transFromNameLike" placeholder="" :maxlength="80"></h-input>
                </h-form-item>
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/impawnRgst/impawnRgstTrackSearch/func_pagingQueryPaperRgstTrackSearch"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
    ...
    methods: {
     /* //机构树多选
      ...
      resetSearch() {
        ...
        this.formItem.transFromNameLike = "";
        this.formItem.transFromAcctNo = "";
      ...
      //导出
      exportExcel() {
        this.param = "impawnRgstTrackSearchExportInfo";
      ...
      exportList(field, exportType) {
        ...
        if (exportType === "1") {
          let url = window.LOCAL_CONFIG.API_HOME + "/ce/cpesrgst/impawnRgst/impawnRgstTrackSearch/func_exportRgstInfo";
          let params = null;
          if (this.$refs.datagrid.selectIds.length !== 0) {
            params = {
            ...
            params = {
              ...
              transFromNameLike: this.formItem.transFromNameLike,
              transFromAcctNo: this.formItem.transFromAcctNo,
