      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/impawnRgst/impawnRgstCancel/func_pagingQueryPaperRgstCancel"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
  ...
  export default {
    ...
    methods: {
      ...
      handleRgstCancel() {
        ...
        post({ ids: ids }, "/ce/cpesrgst/impawnRgst/impawnRgstCancel/func_cancelRegister").then(res => {
          if (res) {
