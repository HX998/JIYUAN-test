      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/stopPaymentRgst/stopPaymentRgstTrackSearch/func_pagingQueryPaperRgstTrackSearch"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
...
<script>
  ...
  export default {
    name: "stopPaymentRgstTrackSearch",
    components: {
    ...
    mounted() {
      ...
      getDictListByGroups("CorpScale,Yon,Province,Industry,ImgStatus,DraftTypeCode,AcptRgstStatus,SspdType").then(res => {
    ...
    methods: {
      ...
      //导出
      exportExcel() {
        this.param = "stopPaymentRgstTrackSearchExportInfo";
