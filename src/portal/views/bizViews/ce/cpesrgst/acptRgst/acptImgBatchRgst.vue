...
<!--                <h-form-item prop="rgstBrchNameList" :label="$t('m.i.ce.rgstBrchName')">
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/acptRgst/acptImgBatchRgst/func_pagingQueryAcptImgPackage"
                      highlightRow
                      :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      return {
        ...
        isDisabled: false,
        fileComitUrl: window.LOCAL_CONFIG.API_HOME + "/ce/cpesrgst/acptRgst/acptImgBatchRgst/func_uploadAcptImgPackage",
        failInfoUrl: "/ce/cpesrgst/acptRgst/acptImgBatchRgst/func_pagingQueryAcptImgErrorInfo",
        fileSelect: true,
        btnShow: false,
     ...
     /* queryBranchTree() {
      ...
      batchMatchImgRgst() {
        ...
        this.$hMsgBox.confirm({
          ...
          content: "确定匹配登记吗?",
          onOk: () => {
            let url = "/ce/cpesrgst/acptRgst/acptImgBatchRgst/func_matchAcptImgPackage";
      ...
      deleteImgRgstInfo() {
        ...
        this.$hMsgBox.confirm({
          ...
          onOk: () => {
            let url = "/ce/cpesrgst/acptRgst/acptImgBatchRgst/func_deleteAcptImgPackage";
            post({id: this.currentSelectRow.id}, url).then(res => {
              if (res) {
                let retCode = res.data.retCode;
                if (retCode === "000000") {
