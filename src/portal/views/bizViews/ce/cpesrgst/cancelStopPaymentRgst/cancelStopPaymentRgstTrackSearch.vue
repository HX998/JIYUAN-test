      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/cancelStopPaymentRgst/cancelStopPaymentRgstTrackSearch/func_pagingQueryPaperRgstTrackSearch"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
...
<script>
  ...
  export default {
    name: "cancelStopPaymentRgstTrackSearch",
    components: {
    ...
    mounted() {
      ...
      getDictListByGroups("CorpScale,Yon,Province,Industry,ImgStatus,DraftTypeCode,AcptRgstStatus,AnlgSspdType").then(res => {
    ...
    methods: {
     /* //机构树多选
      ...
      //导出
      exportExcel() {
        this.param = "cancelStopPaymentRgstTrackSearchExportInfo";
      ...
      exportList(field, exportType) {
        ...
        if (exportType === "1") {
          let url = window.LOCAL_CONFIG.API_HOME + "/ce/cpesrgst/cancelStopPaymentRgst/cancelStopPaymentRgstTrackSearch/func_exportRgstInfo";
          let params = null;
          if (this.$refs.datagrid.selectIds.length !== 0) {
            params = {
          ...
          if (this.$refs.datagrid.selectIds.length !== 0) {
            ...
            let url = window.LOCAL_CONFIG.API_HOME + "/ce/cpesrgst/stopPaymentRgst/stopPaymentRgstTrackSearch/func_exportRgstInfo";
            let form = document.createElement("form");
