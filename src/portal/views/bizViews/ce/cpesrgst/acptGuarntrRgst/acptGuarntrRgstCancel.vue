      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/ce/cpesrgst/acptGuarntrRgst/acptGuarntrRgstCancel/func_pagingQueryPaperRgstCancel"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
  ...
  export default {
    ...
    methods: {
      ...
      handleRgstCancel() {
        ...
        post({ listIds: ids }, "/ce/cpesrgst/acptGuarntrRgst/acptGuarntrRgstCancel/func_cancelAcptGuarntrRgst").then(res => {
          if (res) {
