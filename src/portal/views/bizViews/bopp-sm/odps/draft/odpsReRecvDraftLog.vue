          ...
          <h-panel class="h-main-search h-form-search clearfix">
            <h-form :model="draftInfoForm" :label-width="115" ref="draftInfoForm" cols="1" class="h-form-search">
              <div class="h-search-form-row">
                <h-form-item :label="$t('m.i.shcpe.draftContent')" prop="draftContent" class="h-form-height-auto" required>
      ...
      formAdd() {
        this.$refs["draftInfoForm"].validate(valid => {
          if (valid) {
            ...
            post({draftContent:draftContent}, "/sm/odps/draft/odpsReRecvDraftLog/func_reRecvMsg").then(res => {
