<template>
  <!--分配业务参数弹出框-->
  <h-msg-box v-model="tempDistributeParamWin" width="1000" :mask-closable="false" @on-close="handleClose" top="10"
...
<script>
  ...
  export default {
    ...
    computed: {
      tempDistributeParamWin: {
        get() {
          return this.distributeParamWin;
        },
        set() {
        }
      }
    ...
    methods: {
      ...
      handleClose() {
        ...
        this.$emit("distributeParamWinClose", "");
      },
      submitForm() {
        ...
        if (list != null && list.length > 0) {
          this.$hMsgBox.confirm({
            ...
            onOk: () => {
              ...
              let params = { ids: this.paramIds, legalNos: legalNos };
              let url = "/sm/auth/parameter/businessParameter/func_allocationParameter";
              post(params, url).then(res => {
                ...
                if (res) {
                  ...
                  if (retCode === "000000") {
                    ...
                    this.$emit("distributeParamSubmit", null);
                  } else {
