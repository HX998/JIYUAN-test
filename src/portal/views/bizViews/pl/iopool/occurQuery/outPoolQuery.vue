          ...
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item :label="$t('m.i.pl.getWay')" prop="getWay">
                  <h-select v-model="formItem.getWay" placeholder="">
  ...
  export default {
    ...
    data() {
      return {
        ...
        ifShowMore : false,
        dataUrl : "/pl/iopool/occurQuery/outPoolQuery/func_queryBatchList",
        billOriginArray: [],
        formItem : {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,GetWay,BillOrigin").then(res => {
        ...
        this.getWayList = res.get("GetWay").filter(item => item.key === "1" || item.key === "5");
    ...
    methods: {
      ...
      queryBatch() {
        ...
        this.dataUrl = "/pl/iopool/occurQuery/outPoolQuery/func_queryBatchList";
        this.$nextTick(() => {
      ...
      queryBill(batchId) {
        ...
        this.dataUrl = "/pl/iopool/occurQuery/outPoolQuery/func_queryBillList";
        this.$nextTick(() => {
      ...
      //清单导出
      billExport() {
        this.param = 'getOutPoolQueryExportInfo';
      ...
      batchExport() {
        this.param = 'getOutPoolQueryBatchExportInfo';
        if (this.$refs.datagrid.selectIds.length !== 0) {
          this.rows = this.$refs.datagrid.selectIds.length;
        }else {
          this.rows = this.$refs.datagrid.total;
      ...
      exportList(field, exportType) {
        ...
        if (exportType === "1") {
          ...
          let url = '';
          if ('getOutPoolQueryExportInfo' === this.param) {
            url = window.LOCAL_CONFIG.API_HOME + "/pl/iopool/occurQuery/outPoolQuery/func_exportData";
          }else if ('getOutPoolQueryBatchExportInfo' === this.param) {
            url = window.LOCAL_CONFIG.API_HOME + "/pl/iopool/occurQuery/outPoolQuery/func_exportBatchData";
          }
          let params = null;
          if (this.$refs.datagrid.selectIds.length !== 0) {
            params = {
