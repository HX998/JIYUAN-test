...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/paper/pOutPoolRgstApplyMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
    ...
    <io-pool-rgst-apply-bill :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams"  ioFlag="2"
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,Yon,ImpawnRgstStatus,GetWay").then(res => {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/paper/pOutPoolRgstApplyMain/func_pagingQueryOutPoolBill";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/outpool/paper/pOutPoolRgstApplyMain/func_queryBatchInfo";
        this.ioPoolBillParams.funcNo = "PIPL040213";
        this.mainVue = false;
