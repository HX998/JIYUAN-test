...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/paper/pOutPoolRgstRecheckMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
    ...
    <io-pool-rgst-recheck-bill :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams" ioFlag="2"
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/paper/pOutPoolRgstRecheckMain/func_pagingQueryOutPoolBill";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/outpool/paper/pOutPoolRgstRecheckMain/func_queryBatchInfo";
        this.mainVue = false;
