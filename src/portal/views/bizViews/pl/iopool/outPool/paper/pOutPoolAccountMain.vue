...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/paper/pOutPoolAccountMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
    ...
    <io-pool-account-bill :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams"
                          @returnAccountMain="returnAccountMain"></io-pool-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "pOutPoolAccountMain",
    components: {
      IoPoolAccountBill: () => import(/* webpackChunkName: "pl/iopool/common/ioPoolAccountBill"*/ '@/views/bizViews/pl/iopool/common/ioPoolAccountBill')
    },
    data() {
      let columns= [
            {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,Yon,GetWay").then(res => {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/paper/pOutPoolAccountMain/func_pagingQueryOutPoolBill";
        this.ioPoolBillParams.acctRecordUrl = "/pl/iopool/outpool/paper/pOutPoolAccountMain/func_getOutPoolAccount";
        this.ioPoolBillParams.acctSubmitUrl = "/pl/iopool/outpool/paper/pOutPoolAccountMain/func_outPoolAccount";
        this.ioPoolBillParams.acctBackUrl = "/pl/iopool/outpool/paper/pOutPoolAccountMain/func_outPoolAccountBack";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/outpool/paper/pOutPoolAccountMain/func_queryBatchInfo";
        this.mainVue = false;
