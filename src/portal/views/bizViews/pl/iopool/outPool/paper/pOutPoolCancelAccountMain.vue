      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/paper/pOutPoolCancelAccountMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="cancelAccount()">{{$t('m.i.pl.cancelAccountMain')}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    </h-row>
    <io-pool-cancel-account-bill :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams"
                                 @returnCancelAccountMain="returnCancelAccountMain"></io-pool-cancel-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "pOutPoolCancelAccountMain",
    components: {
      IoPoolCancelAccountBill: () => import( /* webpackChunkName: "pl/iopool/common/ioPoolCancelAccountBill" */ '@/views/bizViews/pl/iopool/common/ioPoolCancelAccountBill')
    },
    data() {
      let columns= [
            {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/paper/pOutPoolCancelAccountMain/func_pageQueryCancelAcctFlow";
        this.ioPoolBillParams.cancelAcctUrl = "/pl/iopool/outpool/paper/pOutPoolCancelAccountMain/func_cancelOutPoolAccount";
        this.ioPoolBillParams.dataDetailUrl = "/pl/iopool/outpool/paper/pOutPoolCancelAccountMain/func_pagingQueryOutPoolBill";
        this.mainVue = false;
