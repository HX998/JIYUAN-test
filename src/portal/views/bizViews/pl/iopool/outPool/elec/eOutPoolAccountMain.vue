      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/elec/eOutPoolAccountMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
            :onCurrentChange="handleCurrentChange"
            :onCurrentChangeCancel="handleCurrentChangeCancel"
            ref="datagrid">
            <div slot="toolbar" class="pull-left">
              <h-button type="primary" @click="account()">{{$t('m.i.pl.balance')}}</h-button>
            </div>
          </h-datagrid>
        </div>
      </h-col>
    </h-row>
    <e-io-pool-account-bill :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams"
                          @returnAccountMain="returnAccountMain"></e-io-pool-account-bill>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "eOutPoolAccountMain",
    components: {
      eIoPoolAccountBill: () => import(/* webpackChunkName: "pl/iopool/common/ioPoolAccountBill" */ '@/views/bizViews/pl/iopool/common/eIoPoolAccountBill')
    },
    data() {
      let columns = [
        {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,Yon,GetWay,BillOrigin").then(res => {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.funcNo = this.formItem.funcNo;
        this.ioPoolBillParams.billClass = this.formItem.billClass;
        this.ioPoolBillParams.accountType = "outPool";
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/elec/eOutPoolAccountMain/func_pagingQueryOutPoolBill";
        this.ioPoolBillParams.acctRecordUrl = "/pl/iopool/outpool/elec/eOutPoolAccountMain/func_getOutPoolAccount";
        this.ioPoolBillParams.acctSubmitUrl = "/pl/iopool/outpool/elec/eOutPoolAccountMain/func_outPoolAccount";
        this.ioPoolBillParams.acctBackUrl = "/pl/iopool/outpool/elec/eOutPoolAccountMain/func_outPoolAccountBack";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/outpool/elec/eOutPoolAccountMain/func_queryBatchInfo";
        this.mainVue = false;
