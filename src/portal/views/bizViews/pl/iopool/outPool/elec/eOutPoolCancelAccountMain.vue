      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/elec/eOutPoolCancelAccountMain/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    name: "eOutPoolCancelAccountMain",
    components: {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/elec/eOutPoolCancelAccountMain/func_pageQueryCancelAcctFlow";
        this.ioPoolBillParams.cancelAcctUrl = "/pl/iopool/outpool/elec/eOutPoolCancelAccountMain/func_cancelOutPoolAccount";
        this.ioPoolBillParams.dataDetailUrl = "/pl/iopool/outpool/elec/eOutPoolCancelAccountMain/func_pagingQueryOutPoolBill";
        this.mainVue = false;
