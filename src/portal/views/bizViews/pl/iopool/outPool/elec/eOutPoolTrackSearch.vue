      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/outpool/elec/eOutPoolTrackSearch/func_pagingQueryOutPoolBatchList"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,Yon,ImpawnRgstStatus,UpbsQueryAnswerStatus,GetWay,BillOrigin").then(res => {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/outpool/elec/eOutPoolTrackSearch/func_pagingQueryOutPoolBill";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/outpool/elec/eOutPoolTrackSearch/func_queryBatchInfo";
        this.mainVue = false;
