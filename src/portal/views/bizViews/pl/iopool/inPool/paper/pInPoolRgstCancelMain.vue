      ...
      <h-col span="24">
        <div v-if="mainVue">
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/paper/pInPoolRgstCancelMain/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        formItem : {
          ...
          batchNo:"",
          inPoolDt:"",
          impawnRgstDt: window.sessionStorage.getItem("workDate").replace(/-/g, ""),
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/paper/pInPoolRgstCancelMain/func_pagingQueryInPoolBill";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/inpool/paper/pInPoolRgstCancelMain/func_getInPoolBatchDtoByConditon";
        this.mainVue = false;
