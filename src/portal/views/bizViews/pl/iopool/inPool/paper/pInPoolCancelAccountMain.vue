      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/paper/pInPoolCancelAccountMain/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      ...
      return {
        ...
        formItem : {
          ...
          custName: "",
          custAcctNo: "",
          impawnRgstStatusList: ["BTC01", "BTC06", "BTC09"]
        },
        columns : columns,
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/paper/pInPoolCancelAccountMain/func_pageQueryCancelAcctFlow";
        this.ioPoolBillParams.cancelAcctUrl = "/pl/iopool/inpool/paper/pInPoolCancelAccountMain/func_cancelInPoolAccount";
        this.ioPoolBillParams.dataDetailUrl = "/pl/iopool/inpool/paper/pInPoolCancelAccountMain/func_pagingQueryInPoolBill";
        this.mainVue = false;
