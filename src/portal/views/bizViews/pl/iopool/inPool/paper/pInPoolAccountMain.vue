      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/paper/pInPoolAccountMain/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/paper/pInPoolAccountMain/func_pagingQueryInPoolBill";
        this.ioPoolBillParams.acctRecordUrl = "/pl/iopool/inpool/paper/pInPoolAccountMain/func_getInPoolAccount";
        this.ioPoolBillParams.acctSubmitUrl = "/pl/iopool/inpool/paper/pInPoolAccountMain/func_inPoolAccount";
        this.ioPoolBillParams.acctBackUrl = "/pl/iopool/inpool/paper/pInPoolAccountMain/func_inPoolAccountBack";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/inpool/paper/pInPoolAccountMain/func_getInPoolBatchDtoByConditon";
        this.mainVue = false;
