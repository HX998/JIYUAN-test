      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/elec/eInPoolAccountMain/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/elec/eInPoolAccountMain/func_pagingQueryInPoolBill";
        this.ioPoolBillParams.acctRecordUrl = "/pl/iopool/inpool/elec/eInPoolAccountMain/func_getInPoolAccount";
        this.ioPoolBillParams.acctSubmitUrl = "/pl/iopool/inpool/elec/eInPoolAccountMain/func_inPoolAccount";
        this.ioPoolBillParams.acctBackUrl = "/pl/iopool/inpool/elec/eInPoolAccountMain/func_inPoolAccountBack";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/inpool/elec/eInPoolAccountMain/func_getInPoolBatchDtoByConditon";
        this.mainVue = false;
