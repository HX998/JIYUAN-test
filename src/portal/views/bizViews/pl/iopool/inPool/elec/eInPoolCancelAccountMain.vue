      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/elec/eInPoolCancelAccountMain/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
  ...
  export default {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/elec/eInPoolCancelAccountMain/func_pageQueryCancelAcctFlow";
        this.ioPoolBillParams.cancelAcctUrl = "/pl/iopool/inpool/elec/eInPoolCancelAccountMain/func_cancelInPoolAccount";
        this.ioPoolBillParams.dataDetailUrl = "/pl/iopool/inpool/elec/eInPoolCancelAccountMain/func_pagingQueryInPoolBill";
        this.mainVue = false;
