...
<template>
  <div class="layout">
      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/pl/iopool/inpool/elec/eInPoolTrackSearch/func_pagingQueryInPoolBatchList"
            :bindForm="formItem"
    ...
    <e-io-pool-track-search :billManagerVue="billManagerVue" :ioPoolBillParams="ioPoolBillParams" :batchInfoShowVue=true
                          @returnTrackSearchMain="returnTrackSearchMain"></e-io-pool-track-search>
    <!-- 查询客户信息弹窗 -->
...
<script>
  ...
  export default {
    name: "eInPoolTrackSearch",
    components: {
      EIoPoolTrackSearch: () => import(/* webpackChunkName: "pl/iopool/common/ioPoolTrackSearch" */ '@/views/bizViews/pl/iopool/common/eIoPoolTrackSearch')
    },
    data() {
      let columns = [
        {
    ...
    mounted() {
      this.getDictListByGroups("DraftTypeCode,ImpawnRgstStatus,UpbsQueryAnswerStatus,Yon,BillOrigin").then(res => {
    ...
    methods: {
      ...
      assembleParams() {
        ...
        this.ioPoolBillParams.dataUrl = "/pl/iopool/inpool/elec/eInPoolTrackSearch/func_pagingQueryInPoolBill";
        this.ioPoolBillParams.replyResultUrl = "/pl/iopool/inpool/elec/eInPoolTrackSearch/func_pagingQueryRecvQueryOccurList";
        this.ioPoolBillParams.batchInfoUrl = "/pl/iopool/inpool/elec/eInPoolTrackSearch/func_getInPoolBatchDtoByConditon";
        this.mainVue = false;
