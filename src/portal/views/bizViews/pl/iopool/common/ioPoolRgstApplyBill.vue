        ...
        <div>
          ...
          <h-datagrid :columns="columns"
            ...
            <div slot="toolbar" class="pull-left">
              <h-dropdown placement="bottom-start" @on-click="submitRecheck">
                <h-button type="primary">{{$t('m.i.common.submitCheck')}}
  ...
  export default {
    ...
    methods: {
      ...
      handleAccountSubmit(params, type) {
        let url = this.ioPoolBillParams.accountType === "inPool" ? "/pl/iopool/inpool/paper/pInPoolRgstApplyMain/func_applInPoolRgst" : "/pl/iopool/outpool/paper/pOutPoolRgstApplyMain/func_applOutPoolRgst";
