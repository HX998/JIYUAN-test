        ...
        <div>
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item :label="$t('m.i.billInfo.minBillPackageMoney')" prop="minBillMoney"
                ...
                <h-form-item :label="$t('m.i.billInfo.maxBillPackageMoney')" prop="maxBillMoney"
                             class="h-form-long-label">
          ...
          <h-datagrid
            ...
            <div slot="toolbar" class="pull-left">
              ...
              <h-button type="primary" @click="replyResult()"
                        v-if="ioPoolBillParams.accountType === 'inPool' && ioPoolBillParams.billClass === 'ME01'">
    ...
    return {
      ...
      billManagerColumns: [
        ...
        },
        {
          ...
          hiddenCol: false,
          render: (h, params) => {
            let list = this.getDictValueFromMap(this.ioPoolBillParams.dictMap, "BillOrigin", params.row.billOrigin);
            return h("span",
              {
                domProps: {
                  title: list
      ...
      if (val) {
        ...
        this.$nextTick(() => {
          if (this.ioPoolBillParams.accountType === "inPool") {
            this.billManagerColumns.splice(6, 1, this.impawnRgstStatus);
            this.columns = this.deepClone(this.billManagerColumns);
          } else {
            if (this.ioPoolBillParams.billClass === "ME02") {
              this.eOutPoolColumns.splice(6, 1, this.unimpawnRgstStatus);
              this.columns = this.deepClone(this.eOutPoolColumns);
            } else {
              this.billManagerColumns.splice(6, 1, this.unimpawnRgstStatus);
              this.columns = this.deepClone(this.billManagerColumns);
            }
          }
  ...
  methods: {
    ...
    assemblePrsttnBillParams() {
      ...
      for (let i = 0; i < vocherData.length; i++) {
        let printData = {};
        printData.billOrigin = !!vocherData[i].billOrigin ? this.getDictValueFromMap(this.ioPoolBillParams.dictMap, "BillOrigin", vocherData[i].billOrigin) : "";
