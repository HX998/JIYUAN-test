...
<script>
  ...
  export default {
    ...
    mounted() {
      getDictListByGroups("DraftTypeCode,CheckType,Yon").then(res => {
    ...
    methods: {
      ...
      getBatchInfo() {
        ...
        post(params, "/pl/custody/paper/saveBill/saveBillTrackSearch/func_pageQuerySaveBatchTrack").then(res => {
          if(res) {
