<template>
  <div>
    ...
    <!--票面信息-->
    <bill-info-main @billInfoWinClose="billInfoWinClose" :showBillInfoWin="showBillInfoWin" :bill-range-start="this.billRangeStart" :bill-range-end="this.billRangeEnd" :billId="this.billId" :billNo="this.billNo"></bill-info-main>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted() {
      getDictListByGroups("DraftTypeCode,CheckType,Yon,BillOrigin").then(res => {
    ...
    methods: {
      ...
      getBatchInfo() {
        ...
        post(params, "/pl/custody/elec/saveBill/eSaveBillTrackSearch/func_pageQuerySaveBatchTrack").then(res => {
          if(res) {
