          ...
          <div class="h-form-search-box">
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                <show-branch v-model="formItem.transBrchNoList" :label="$t('m.i.pl.transBrchName')" prop="transBrchNoList" :showCheckBox="true"
  ...
  export default {
    ...
    data() {
      return {
        ...
        hasSelect : false,
        ifShowMore : false,
        dataUrl : "/pl/custody/occurQuery/getBillQuery/func_pageOccurQueryGetBatchList",
        billOriginArray: [],
        formItem : {
        ...
        billColumns : [
          ...
          },
          {
            ...
            render: (h, params) => {
              let value = "";
              if(params.row.stockStatus === "1" || params.row.stockStatus === "6") {
                value = "在库";
              }else if(params.row.stockStatus === "2" || params.row.stockStatus === "5") {
                value = "出库";
              }else {
                value = this.getDictValueFromMap(this.dictMap, "PoolBillStockStatus", params.row.stockStatus);
              }
              return h("span", {
                domProps: {
                  title: value
    ...
    methods: {
      ...
      queryBatch() {
        ...
        this.dataUrl = "/pl/custody/occurQuery/getBillQuery/func_pageOccurQueryGetBatchList";
        this.$nextTick(() => {
          this.columns = this.deepClone(this.batchColumns);
          this.$refs.datagrid.createShowCol(this.batchColumns);
        });
      ...
      queryBill(batchId) {
        ...
        this.dataUrl = "/pl/custody/occurQuery/getBillQuery/func_pageOccurQueryGetBillList";
        this.$nextTick(() => {
      ...
      //明细导出
      billExport() {
        this.param = 'getBillOccurExportInfo';
      ...
      batchExport() {
        this.param = 'getBatchOccurExportInfo';
        if (this.$refs.datagrid.selectIds.length !== 0) {
          this.rows = this.$refs.datagrid.selectIds.length;
        }else {
          this.rows = this.$refs.datagrid.total;
      ...
      exportList(field, exportType){
        ...
        if(exportType === "1"){
          ...
          let billIds = null;
          let batchIds= null;
          if ('getBillOccurExportInfo' === this.param) {
            url = window.LOCAL_CONFIG.API_HOME + "/pl/custody/occurQuery/getBillQuery/func_exportGetBillOccurExcel";
            billIds = this.$refs.datagrid.selectIds;
          }else if ('getBatchOccurExportInfo' === this.param) {
            url = window.LOCAL_CONFIG.API_HOME + "/pl/custody/occurQuery/getBillQuery/func_exportGetBatchOccurExcel";
          ...
          if (this.$refs.datagrid.selectIds.length !== 0) {
            ...
            params = { transBrchNoList:this.formItem.transBrchNoList, acptName:this.formItem.acptName, billType:this.formItem.billType,
