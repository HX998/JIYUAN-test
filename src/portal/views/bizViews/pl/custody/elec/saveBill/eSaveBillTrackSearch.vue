      ...
      <h-col span="24">
        ...
        <div v-if="mainVue" key="1">
          ...
          <h-datagrid :columns="columns"
                      highlightRow
                      url="/pl/custody/elec/saveBill/eSaveBillTrackSearch/func_pageQuerySaveBatchTrack"
                      :bindForm="formItem"
        ...
        <save-bill-batch-info-detail  :is-show="billManagerVue" :params="batchInfoParams" ref="saveBillBatchInfoDetail"
                                      batchInfoUrl="/pl/custody/elec/saveBill/eSaveBillTrackSearch/func_pageQuerySaveBatchList"></save-bill-batch-info-detail>
        <!-- 数据展示表格 -->
        <div v-if="billManagerVue" key="2">
          <h-datagrid :columns="billManagerColumns"
                      url="/pl/custody/elec/saveBill/eSaveBillTrackSearch/func_saveBillInfoTrackSearch"
                      :auto-load="false"
                      :row-select="true"
        ...
        <!--票面信息-->
        <bill-info-main @billInfoWinClose="billInfoWinClose" :showBillInfoWin="showBillInfoWin" :bill-range-start="this.billRangeStart" :bill-range-end="this.billRangeEnd"
...
<script>
  ...
  export default {
    ...
    mounted() {
      getDictListByGroups("DraftTypeCode,CheckType,BillOrigin").then(res => {
