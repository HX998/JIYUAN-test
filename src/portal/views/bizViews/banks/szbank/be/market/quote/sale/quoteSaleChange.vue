...
<script >
  ...
  export default {
    ...
    components:{
      ...
      QuoteInput:()=>import(/* webpackChunkName: "banks/szbank/be/market/quote/sale/quoteSaleInput" */`@/views/bizViews/banks/szbank/be/market/quote/sale/quoteSaleInput`),
    ...
    methods:{
      turnForm(formItem,obj){
        ...
        if (obj.isSendDraft) {
          formItem.isSendDraft=obj.isSendDraft
        }
        formItem.reserve1=obj.reserve1;
        formItem.reserve2=obj.reserve2;
        formItem.reserve3=obj.reserve3
      },
      billInfoWinClose(){
        this.billId=null;
        this.billNo=null;
