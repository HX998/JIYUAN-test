...
<script>
  ...
  export default {
    ...
    components: {
      EImpawnApplyAdd:()=>import(/* webpackChunkName: "banks/szbank/ce/impawn/elec/elecImpawn/eImpawnApplyAdd" */`@/views/bizViews/banks/szbank/ce/impawn/elec/elecImpawn/eImpawnApplyAdd`),
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title: this.$t("m.i.ce.collectionAccount"),
            key: "reserve1",
            hiddenCol: false
          },
          {
