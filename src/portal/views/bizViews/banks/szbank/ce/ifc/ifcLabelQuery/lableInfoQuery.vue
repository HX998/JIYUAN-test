      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      url="/be/market/ifclabel/ifcLableApply/func_queryLableInfoHist"
                      :bindForm="formItem"
                      :has-select="false"
                      :row-select="true"
                      ref="datagrid">
...
<script>
  ...
  export default {
    ...
    mounted() {
        getDictListByGroups("DraftTypeCode,CDMedia,Yon,CorpScale,RediscSupplStatus,Industry,AcptRgstStatus,BillOrigin,LabelTypeClass,ReportStatusClass,MessageTypeClass").then(res => {
    ...
    methods: {
      ...
      //导出
      exportExcel() {
        this.param = 'labelInfoExportInfo';
      ...
      exportList(field, exportType) {
        ...
        let url = window.LOCAL_CONFIG.API_HOME + "/be/market/ifclabel/ifcLableApply/func_exportLableInfo";
