      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid :columns="columns"
                      ...
                      :row-select="true"
                      :has-select="false"
                      url="/banks/szbank/ce/acpt/elec/guarntrPaymentDue/guarntrPaymentSignMain/func_pageQueryGuarntrPaymentSignList"
                      :bindForm="formItem"
                      ref="datagrid">
...
export default {
  ...
  methods: {
    ...
    paymentSignSubmit() {
      ...
      post({ids: ids}, "/banks/szbank/ce/acpt/elec/guarntrPaymentDue/guarntrPaymentSignMain/func_guarntrPaymentDueSign").then(res => {
        if (res) {
    ...
    confirmBack() {
      ...
      post({ids: ids}, "/banks/szbank/ce/acpt/elec/guarntrPaymentDue/guarntrPaymentSignMain/func_guarntrPaymentDueSignReturn").then(res => {
        if (res) {
          let msg = res.data.retMsg;
          let retCode = res.data.retCode;
          if (retCode === "000000") {
