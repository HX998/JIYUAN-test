...
export default {
  ...
  data() {
    return {
      formItem: {
        ...
        reportName: "discAcptRatioReport",
  ...
  methods: {
    ...
    createReport() {
      ...
      reportFunc.createReport(this, "/banks/szbank/pc/report/discAcptRatioReport/func_sendQueryReport", this.formItem);
    },
    ...
    downReport(id, status) {
      reportFunc.downReport(this, {
        status: status,
        downReportUrl: "/banks/szbank/pc/report/discAcptRatioReport/func_report",
        urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
        downReportTitle: "签贴比报表"
      });
    }
  }
};
