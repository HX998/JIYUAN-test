      ...
      <div>
        <h-form :model="recheckForm" :label-width="115" ref="recheckForm" cols="2" class="h-form-search">
          ...
          <h-form-item prop="pyeeBankName" :label="$t('m.i.billInfo.pyeeBankName')">
            <h-input v-model="recheckForm.pyeeBankName" placeholder="" :maxlength="76"  :readonly="qiyeReadonly && rejectReadonly"></h-input>
          </h-form-item>
  ...
  export default {
    ...
    methods: {
            ...
            post(this.recheckForm, url).then(res => {
              ...
              if (res) {
                ...
                if (retCode === "000000") {
                  ...
                  // 个性化点  打印凭证
                  this.printVoucher(this.recheckForm);
      ...
      printVoucher(recheckForm){
        ...
        let voucherType=this.rejectReadonly?"BE031807":"BE031809";
        let params = {templateName: voucherType, params: JSON.stringify(param),listIds: recheckForm.id,saveFlag:1,batchNo:recheckForm.batchNo};
