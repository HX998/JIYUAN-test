        ...
        <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
          <h-form :model="billManagerFormItem" :label-width="90" ref="billManagerFormItem" cols="4" class="h-form-search">
            <h-form-item prop="foreFlowNo" :label="$t('m.i.common.foreFlowNo')">
              <h-input v-model="billManagerFormItem.foreFlowNo" placeholder="" :readonly="foreFlowNoReadonly"></h-input>
            </h-form-item>
            <h-form-item prop="backFlowNo" :label="$t('m.i.common.backFlowNo')">
              <h-input v-model="billManagerFormItem.backFlowNo" placeholder="" :readonly="backFlowNoReadonly"></h-input>
            </h-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        foreFlowNoReadonly:false,
        backFlowNoReadonly:false,
    ...
    mounted() {
      ...
      if (this.billManagerParams.foreFlowNo) {
        this.foreFlowNoReadonly=true;
        this.billManagerFormItem.foreFlowNo=this.billManagerParams.foreFlowNo;
      }
      if (this.billManagerParams.backFlowNo) {
        this.backFlowNoReadonly=true;
        this.billManagerFormItem.backFlowNo=this.billManagerParams.backFlowNo;
      }
    ...
    methods: {
      ...
      billManagerResetSearch(){
        this.$nextTick(() => {
          if (!this.foreFlowNoReadonly) {
            this.billManagerFormItem.foreFlowNo = '';
          }
          if (!this.backFlowNoReadonly) {
