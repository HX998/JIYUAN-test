    ...
    <h-row name="flex" class="layout-menu-wrapper">
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            url="/pb/recourse/recourseClear/func_queryCheckRecourseClearBillByPage"
            :bindForm="formItem"
            :hasSelect="false"
            rowSelect
            :notSetWidth="true"
  ...
  export default {
    ...
    methods: {
      ...
      passSubmit() {
        ...
        post({ ids: ids }, "/pb/recourse/recourseClear/func_sendRecourseClearBill").then(res => {
          if (res) {
      ...
      refuseSubmit() {
        ...
        post({ ids: ids }, "/pb/recourse/recourseClear/func_refuseRecourseClearBill").then(res => {
          if (res) {
            let retCode = res.data.retCode;
            if (retCode == "000000") {
              this.$msgTip.success(this, { info: "操作成功" });
