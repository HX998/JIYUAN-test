      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlight-row
            url="pb/recourse/elecRecourseApply/inAccountRecourseBill/func_queryStayForAcct"
            :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      return {
        ...
        authPath: this.$route.path,
        //brchNoWin: false,
        accountUrl: "pb/recourse/elecRecourseApply/inAccountRecourseBill/func_recourseAccount",
        acctRecord: "pb/recourse/elecRecourseApply/inAccountRecourseBill/func_recourseQueryAcctRecord",
        param: {},
        ...
        showFileWin:false,
        fileBatchParams:{},
        filePathUrl:"/pb/recourse/elecRecourseApply/inAccountRecourseBill"
      };
    },
    methods: {
      // 打开附件弹窗
    ...
    mounted() {
      this.getDictListByGroups("RcrsTypeCode,CDMedia,DraftTypeCode,executeMode,delayKind,BillOrigin,FileDetailStatus,InRcrsTypeCode").then(res => {
