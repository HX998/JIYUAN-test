...
name: "recourseApplyDetailEcds",
  ...
  methods:{
    ...
    recourseTypeChange(currentValue) {
      if (currentValue === "BC15") {
        this.formItem.recourseReasonCode = "RC00";
      } else {
    ...
    detailSubmitForm() {
      ...
      this.$refs["formItem"].validate(valid => {
        if (valid) {
          ...
          let url = "/pb/recourse/elecRecourseApply/recourseApplyDetailEcds/func_recourseNotificationEcdsRequest";
