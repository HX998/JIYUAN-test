          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item prop="cashStatus" :label="$t('m.i.be.cashStatus')">
                  <h-select v-model="formItem.cashStatus" placeholder="" showTitle>
                    <h-option v-for="item in cashStatusList" :value="item.key" :key="item.key">{{ item.value }}
                    </h-option>
                  </h-select>
                </h-form-item>
                <h-form-item prop="settleStatus" :label="$t('m.i.pe.clearStatus')">
                  <h-select v-model="formItem.settleStatus" placeholder="" showTitle>
                    <h-option v-for="item in settleStatusList" :value="item.key" :key="item.key">{{item.value }}
                    </h-option>
                  </h-select>
                </h-form-item>
                ...
                <show-cpes-branch :label="$t('m.i.be.hldrBrchName')" :brchCode.sync="formItem.hldrBrchCode"  :cpesBrchName.sync="formItem.hldrBrchName"
                                  datagridUrl="/cpes/branch/queryBranchList" prop="hldrBrchName"
                                  queryUrl="/cpes/branch/queryBranchList"></show-cpes-branch>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getParams(){
        if (this.$route.path === "/pb/recourse/acceptBill/recourseAcceptBill") {
