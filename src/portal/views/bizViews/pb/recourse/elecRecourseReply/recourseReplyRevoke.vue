      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlight-row
            url="/pb/recourse/recourseReplyRevoke/func_queryCancelableAgreement"
            :bindForm="formItem"
  ...
  export default {
    ...
    data() {
      return {
        ...
        showFileWin:false,
        fileBatchParams:{},
        filePathUrl:"/pb/recourse/recourseReplyRevoke/",
    ...
    methods: {
      ...
      handleRevoke() {
        ...
        post(params, "/pb/recourse/recourseReplyRevoke/func_cancelAgreementRecourseEcdsRequest").then(res => {
          if (res) {
