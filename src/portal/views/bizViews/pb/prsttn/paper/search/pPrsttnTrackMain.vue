      ...
      <h-col span="24">
          ...
          <div>
            ...
            <div class="h-form-search-box">
              ...
              <h-datagrid
                ...
                :onCurrentChange="handleSelectClick"
        ...
        <div v-if="collectionTrackBillMain" key="2">
          <h-datagrid
            ...
            url="/pb/prsttn/paper/search/pPrsttnTrackMain/func_pageQueryPrsttnBill"
            :row-select="true"
  ...
  export default {
    ...
    methods: {
      ...
      handleForm() {
        ...
        this.billFormItem.ownedBrchNos = this.currentSelectList.ownedBrchNo;
        this.billFormItem.ownedBrchNames = this.currentSelectList.ownedBrchName;
        this.isQuery = true;
      ...
      assemblePrsttnBatchParams(vocherData) {
        ...
        let headHtml = `<div style="text-align:center;" ref="headHtml">
          <div style="text-align:center;font-size:18px;font-weight:bold;">票据银行实物票据邮寄交接清单</div>
        </div>`
        ...
        this.$print.printListHtm(this, headHtml, bodyHtml, { bodyTop: "12%", bodyLeft:"5%", bodyWidth:"90%", bodyHeight:"75%" });
      },
      //托收打印
      prsttnPrint() {
      ...
      prsttnBillPrint() {
        let params = {
          ...
          ownedBrchNos:this.billFormItem.ownedBrchNos,
          ownedBrchNames:this.billFormItem.ownedBrchNames,
          authPath:this.$route.path,
          licenseFlag:this.licenseFlag
        };
        post(params, "/pb/prsttn/paper/search/pPrsttnTrackMain/func_queryPrsttnBill").then(res => {
          if (res) {
            let retCode = res.data.retCode;
            if (retCode === "000000") {
              let list = (res.data.retData.list instanceof Array) ? res.data.retData.list : [res.data.retData.list];
