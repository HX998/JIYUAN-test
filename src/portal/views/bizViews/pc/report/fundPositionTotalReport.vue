<template>
  <div id="fundPositionTotalReport">
  ...
  export default {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "fundPositionTotalReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/report/fundPosition/sendQueryFundPositionTotalReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/report/fundPosition/fundPositionTotalReport",
