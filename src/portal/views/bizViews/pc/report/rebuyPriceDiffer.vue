  ...
  export default {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "rebuyPriceDifferReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/rebuyPriceDiffer/func_sendQueryReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/rebuyPriceDiffer/func_rebuyReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "转贴现价差损益报表"
        });
      }
    }
  };
