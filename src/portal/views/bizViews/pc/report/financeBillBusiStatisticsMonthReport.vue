<template>
  <div id="financeBillBusiStatisticsMonthReport">
...
<script>
  ...
  export default {
    name: "financeBillBusiStatisticsMonthReport",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "billBusiStatisticsMonthReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/financeBillBusiStatisticsMonthReport/func_sendQueryMonthReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/financeBillBusiStatisticsMonthReport/func_billMonthReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "金融机构票据业务统计月报表"
        });
      }
    }
  };
