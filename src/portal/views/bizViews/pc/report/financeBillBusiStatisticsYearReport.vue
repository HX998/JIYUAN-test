<template>
  <div id="financeBillBusiStatisticsYearReport">
...
<script>
  ...
  export default {
    name: "financeBillBusiStatisticsYearReport",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "financeBillBusiStatisticsYearReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/financeBillBusiStatisticsYearReport/func_sendQueryYearReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/financeBillBusiStatisticsYearReport/func_yearReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "年度票据业务经营数据表"
        });
      }
    }
  };
