<template>
  <div id="billBusiSituationMonitorReport">
...
<script>
  ...
  export default {
    name: "billBusiSituationMonitorReport",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "billBusiSituationMonitorReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/billBusiSituationMonitorReport/func_sendMonitorReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/billBusiSituationMonitorReport/func_MonitorReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "商业汇票情况监测表"
        });
      }
    }
  };
