<template>
  <div id="financeBillBusiStatisticsMonthReportTwo">
...
<script>
  ...
  export default {
    name: "financeBillBusiStatisticsMonthReportTwo",
    components: {
    ...
    data() {
      ...
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "billBusiStatisticsMonthTwoReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/financeBillBusiStatisticsMonthReportTwo/func_sendQueryTwoReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/financeBillBusiStatisticsMonthReportTwo/func_twoReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "金融机构票据业务统计月报表(二)"
        });
      }
    }
  };
