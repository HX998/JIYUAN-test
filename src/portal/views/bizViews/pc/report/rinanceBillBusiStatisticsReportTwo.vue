<template>
  <div id="rinanceBillBusiStatisticsReportTwo">
    <div class="h-form-search-box">
      <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
        <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
          <h-form-item :label="$t('m.i.pc.reportDt')" prop="reportDt">
            <h-date-picker :value="formItem.reportDt" type="date" placeholder=""  v-model="formItem.reportDt"  :editable=false :showFormat=true @on-change="handleDateChange"></h-date-picker>
          </h-form-item>
...
<script>
  ...
  export default {
    name: 'rinanceBillBusiStatisticsReportTwo',
    components:{
    ...
    data(){
      return {
        formItem : {
          ...
          reportCnName:'',
          brchNo:'',
          reportName:'financeBillBusiStatisticsTwoReport',
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/rinanceBillBusiStatisticsReportTwo/func_sendQueryTwo", params)
      },
      ...
      downReport(id,status){
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/rinanceBillBusiStatisticsReportTwo/func_financeTwoReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem('userName'),
          downReportTitle: "金融机构票据业务统计季报表(二)"
        });
      }
    }
