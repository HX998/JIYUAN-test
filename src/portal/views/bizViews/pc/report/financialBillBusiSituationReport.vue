<template>
  <div id="financialBillBusiSituationReport">
...
<script>
  ...
  export default {
    name: "financialBillBusiSituationReport",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "financialBillBusiSituationReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/financialBillBusiSituationReport/func_sendFinanceQuery", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/financialBillBusiSituationReport/func_financeReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "银行业金融机构票据业务情况表"
        });
      }
    }
  };
