  ...
  export default {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "billDiscMonthReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/billDiscMonthReport/func_sendQueryReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/billDiscMonthReport/func_monthReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "票据贴现情况每月发生汇总表"
        });
      }
    }
  };
