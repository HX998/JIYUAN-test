  ...
  export default {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "interestMonthReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/report/interestMonth/sendQueryInterestMonthReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/report/interestMonth/interestMonthReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "利润月报表"
        });
      }
    }
  };
