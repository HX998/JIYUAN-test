  ...
  export default {
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/interestSaleReport/func_sendQueryReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/interestSaleReport/func_report",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "收益报表(一)流量业务"
        });
      }
    }
  };
