<template>
  <div id="reBuyContractStatisticsReport">
...
<script>
  ...
  export default {
    name: "reBuyContractStatisticsReport",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "reBuyContractStatisticsReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/reBuyContractStatisticsReport/func_sendQueryReport", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/reBuyContractStatisticsReport/func_reBuyReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "商业汇票转贴现交易标准合同文本使用情况统计表"
        });
      }
    }
  };
