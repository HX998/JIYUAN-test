<template>
  <div id="rinanceBillBusiStatisticsReportOne">
...
<script>
  ...
  export default {
    name: "rinanceBillBusiStatisticsReportOne",
    components: {
    ...
    data() {
      return {
        formItem: {
          ...
          reportCnName: "",
          brchNo: "",
          reportName: "financeBillBusiStatisticsOneReport",
    ...
    methods: {
      createReport() {
        ...
        reportFunc.createReport(this, "/pc/report/rinanceBillBusiStatisticsReportOne/func_sendFinanceOneQuery", params);
      },
      ...
      downReport(id, status) {
        reportFunc.downReport(this, {
          status: status,
          downReportUrl: "/pc/report/rinanceBillBusiStatisticsReportOne/func_financeOneReport",
          urlSuffix: "reportId=" + id + "&userNo=" + window.sessionStorage.getItem("userName"),
          downReportTitle: "金融机构票据业务统计季报表(一)"
        });
      }
    }
  };
