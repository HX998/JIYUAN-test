  ...
  export default {
    ...
    props : {
      ...
      batchUrl : {
        type : String,
        default (){
          return "/pc/stock/outStockBatchMain/func_findStockBatchInfo";
        }
      },
      listIds: "",
      batchId: "",
    ...
    methods: {
      ...
      account() {
        ...
        this.acctRecordParam = {batchId: this.batchId, pageOperType: "0", ids: this.listIds,busiType: "2" }
        this.showAcctRecordWin = true;
      },
      //确定记账
      acctSubmitSure(info) {
        let param = {};
        param = {acctAuthId:this.id,batchId: this.batchId, pageOperType: "0", ids: this.listIds,busiType: "2" };
        this.acctSubmitFlag = true;
        post(param, "/pc/stock/outStockBatchMain/func_acctAuthorizePass").then(res => {
      ...
      submitAcctAuthorizeBack(){
        let param = {};
        param = {acctAuthId:this.id,batchId: this.batchId,pageOperType: "0", ids: this.listIds,busiType: "2"};
        post(param, "/pc/stock/outStockBatchMain/func_acctAuthorizeReturn").then(res => {
          if(res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            if (retCode === "000000") {
