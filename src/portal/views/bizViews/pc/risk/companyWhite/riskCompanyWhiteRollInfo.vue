...
export default {
  ...
  components: {
    CWhiteHist: () => import(/* webpackChunkName: "pc/risk/companyWhite/riskCompanyWhiteRollHist" */`@/views/bizViews/pc/risk/companyWhite/riskCompanyWhiteRollHist.vue`),
  ...
  data() {
    return {
      ...
      brchTypeList: [],
      transBrchClassList: [],
      uploadUrl: window.LOCAL_CONFIG.API_HOME + "/pc/risk/companyWhite/importCompanyWhiteRollInfo",
      importSelect: true,
  ...
  methods: {
    ...
    /**模板下载**/
    downModel() {
      let url = window.LOCAL_CONFIG.API_HOME + "/pc/risk/companyWhite/download";
