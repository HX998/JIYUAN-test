      ...
      <h-col span="24">
        <div>
          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item :label="$t('m.i.common.operStatus')" prop="operStatus">
          ...
          <h-datagrid
                      :columns="columns"
                      highlight-row
                      url="pc/risk/black/indexRiskBlackTrackQuery/func_trackQueryRiskBlackRollHis"
                      :bindForm="formItem"
...
<script>
  ...
  export default {
    ...
    data(){
      let columns = [
        ...
        },
        {
          ...
          hiddenCol: false,
          render: (h, params) => {
            let list = this.getDictValueFromMap(this.dictMap, "BlackCustType", params.row.custType);
            return h("span",
              {
                domProps: {
                  title: list
    ...
    mounted() {
      this.getDictListByGroups("BlackCustType,BrchType,BrchClass,RiskOperStatus").then(res => {
