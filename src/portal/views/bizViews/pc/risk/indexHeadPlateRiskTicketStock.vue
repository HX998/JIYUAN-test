          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              ...
              <h-form-item :label="$t('m.i.pc.pkDt')"  prop="xxx">
                <h-date-picker type="daterange" v-model="formItem.xxx"></h-date-picker>
              </h-form-item>
      ...
      <h-panel>
        <h-form :model="addForm" :label-width="120" ref="addForm" cols="4"  class="h-form-search">
          <h-form-item :label="$t('m.i.billInfo.billNo')" prop="billNo" :required="isRequired" cols="2">
            <h-input v-if="type=='view'" :value="addForm.billNo" class="input-boder-0" :title="addForm.billNo"></h-input>
          ...
          <h-form-item :label="$t('m.i.billInfo.billType')" prop="billType" :required="isRequired" cols="2">
            ...
            <h-select v-else v-model="addForm.billType" showTitle >
              <h-option v-for="item in billTypeList" :value="item.value" :key="item.value">{{ item.label }}</h-option>
            </h-select>
          </h-form-item>
          ...
          <h-form-item :label="$t('m.i.billInfo.drwrName')" prop="remitter" cols="2">
            <h-input v-if="type=='view'" :value="addForm.remitter" class="input-boder-0" :title="addForm.remitter"></h-input>
          ...
          <h-form-item :label="$t('m.i.billInfo.acptName')" prop="acceptor" cols="2">
            <h-input v-if="type=='view'" :value="addForm.acceptor" class="input-boder-0" :title="addForm.acceptor"></h-input>
            <h-input v-else v-model="addForm.acceptor" :maxlength=60></h-input>
          </h-form-item>

          <h-form-item :label="$t('m.i.billInfo.remitDt')" prop="acptDt" cols="2">
            <h-date-picker v-if="type=='view'" :value="addForm.acptDt" class="input-boder-0" :title="addForm.acptDt" type="date"></h-date-picker>
          ...
          <h-form-item :label="$t('m.i.billInfo.dueDt')" prop="dueDt" cols="2">
            <h-date-picker v-if="type=='view'" :value="addForm.dueDt" class="input-boder-0" :title="addForm.dueDt" type="date"></h-date-picker>
          ...
          <h-form-item :label="$t('m.i.billInfo.billMoney')" prop="billMoney" :required="isRequired" cols="2">
            <h-input v-if="type=='view'" :value="addForm.billMoney" class="input-boder-0" :title="addForm.billMoney"></h-input>
            <h-input v-else v-model="addForm.billMoney" :maxlength=60 ></h-input>
          </h-form-item>


          <h-form-item :label="$t('m.i.pc.riskDesc')" prop="riskDesc" cols="2">
            <h-input v-if="type=='view'" :value="addForm.riskDesc" class="input-boder-0" :title="addForm.riskDesc"></h-input>
          ...
          <h-form-item :label="$t('m.i.billInfo.riskStatus')" prop="origin" :required="isRequired" cols="2">
            <h-input v-if="type=='view'" :value="addForm.origin" class="input-boder-0" :title="addForm.origin"></h-input>
...
<script>
  ...
  export default {
    name: "indexHeadPlateRiskTicketStock",
    components: {
    },
    data(){
      return {
