      ...
      <h-col span="24">
        <div>
            ...
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                <div class="h-search-form-row" >
                  <common-date-picker v-model="formItem.startDtArr" :label="$t('m.i.pc.startDate')" prop="startDtArr" type="daterange" :rangeValue="['minStartDt','maxStartDt']"
          ...
          <h-datagrid
            ...
            :hasSelect = false
            :rowSelect = true
            url="/pc/acct/balanceHis/rebuyBalanceHistory/func_queryRebuyBalanceHistory"
            :bindForm="formItem"
            ref="datagrid">
  ...
  export default {
    ...
    methods:{
      getRebuyCurrentlyBalanceRegister() {
        ...
        let url = "/pc/acct/balanceHis/rebuyBalanceHistory/func_queryBuyStockBalanceHistoryCount";
      ...
      tempShowExcelTemplateWinOpen() {
        this.param = 'rebuyBalanceHistoryReportInfo';
      ...
      exportList(field, exportType) {
        let exportUrl = window.LOCAL_CONFIG.API_HOME + "/pc/acct/balanceHis/rebuyBalanceHistory/func_exportRebuyBalanceHistory";
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
