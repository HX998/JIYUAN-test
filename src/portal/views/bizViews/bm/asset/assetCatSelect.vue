        ...
        <div>
          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              ...
              <h-datagrid :columns="columns" highlight-row url="/bm/valuate/AssetCatManage/func_queryAssetCatManageCheckPassByPage"
                          :bindForm="formItem"
  ...
  export default {
    ...
    methods: {
      ...
      viewAssetCat(str){
        ...
        this.showTemColumns=[];
        post({prodNo: this.selectData[0].prodNo}, "/bm/valuate/AssetCatManage/func_queryActiveAssetCatManageDetail").then(res => {
          if (res) {
