  ...
  export default {
    ...
    data() {
      return {
        ...
        totalAmt: "",
        totalNum: "",
        queryUrl: "/pe/busiqry/freezeRegOccurQuery/func_freezeRegOccurQueryByPage",
        billMoneyRule:[{
        ...
        // 查看附件
        showFileWin: false,
        filePathUrl: "/pe/busiqry/freezeRegOccurQuery/",
        fileBatchParams: {},
        //清单导出
        exportParam: "",
        exportRows: "",
    ...
    methods: {
      ...
      //清单导出
      listExport() {
        this.exportParam = "freezeRegOccurQueryExportInfo";
      ...
      exportList(field, exportType) {
        let url = window.LOCAL_CONFIG.API_HOME + "/pe/busiqry/freezeRegOccurQuery/func_exportFreezeRegOccurQueryList";
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
