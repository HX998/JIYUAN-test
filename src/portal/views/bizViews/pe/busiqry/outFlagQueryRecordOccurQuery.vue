              ...
              <h-form ref="formItem" :model="formItem" :label-width="90" class="h-form-search" cols="4">
                <div class="h-search-form-row">
                  <h-form-item prop="custName" :label="$t('m.i.common.custName')">
                    <select-cust-corp v-model="formItem.custNo" :custNo="formItem.custName"
                                      :value.sync="formItem.custNo"
                  ...
                  <h-form-item prop="isPass" :label="$t('m.i.pe.isPass')">
                    <h-select v-model="formItem.isPass" placeholder="">
                  ...
                  <h-form-item prop="custNo" :label="$t('m.i.common.custNo')" v-show=false>
...
<script>
  ...
  export default {
    name: "outFlagQueryRecordOccurQuery",
    components: {
    ...
    data() {
      return {
        ...
        columns: [
          ...
          {
            title:  this.$t("m.i.pe.isPass"),
            key: "isPass",
            hiddenCol: false,
            render: (h, params) => {
              let list = this.getDictValueFromMap(this.dictMap, "Yon", params.row.isPass);
              return h("span",
                {
                  domProps: {
                    title: list
          ...
          },
          {
            ...
            align: "center",
            render: (h, params) => {
              let list = this.getDictValueFromMap(this.dictMap,"UpbsQueryBusiType",params.row.prodNo);
              return h("span",
                {
                  domProps: {
                    title: list
    ...
    mounted() {
      this.getDictListByGroups("CDMedia,DraftTypeCode,RiskStatus,BarterTrustStatus,AcctFlag,Yon,UpbsQueryType,UpbsQueryAnswerStatus,UpbsQueryBusiType").then(res => {
    ...
    methods: {
      ...
      getOccurData() {
        ...
        let url = "/pe/busiqry/outFlagQueryRecordOccurQuery/func_pagingOutFlagQueryRecordOccurQueryList";
      ...
      tempShowExcelTemplateWinOpen() {
        this.param = "getOutFlagQueryRecordOccurQuery";
      ...
      exportList(field, exportType) {
        let exportUrl = window.LOCAL_CONFIG.API_HOME + "/pe/busiqry/outFlagQueryRecordOccurQuery/func_exportQueryRecord";
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
