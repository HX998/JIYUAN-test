...
<script>
  import { formatNumber, off, on, post,exportList,formatBillRange } from "@/api/bizApi/commonUtil";

  export default {
    name: "ceImpawnOccurQuery",
    components: {
    ...
    data() {
      ...
      return {
        ...
        //showBranchWin : false,
        queryUrl : "/ce/impawn/occurQuery/func_pageQueryImpawnBacthOccur",
    ...
    methods: {
      ...
      queryImpawnOccurBatch() {
        ...
        this.queryUrl = "/ce/impawn/occurQuery/func_pageQueryImpawnBacthOccur";
      ...
      queryImpawnOccurBill() {
        this.$refs.datagrid.url = null;
        this.queryUrl = "/ce/impawn/occurQuery/func_pageQueryImpawnBillOccur";
      ...
      tempShowExcelTemplateWinOpen(type) {
        ...
        if (type === "batch") {
          this.param = "ceImpawnBatchOccurExportInfo";
        } else {
          this.param = "ceImpawnBillOccurExportInfo";
        }
      ...
      exportList(field, exportType) {
        ...
        if (this.selectExportType === "batch") {
          exportUrl = window.LOCAL_CONFIG.API_HOME + "/ce/impawn/occurQuery/func_exportImpawnBatchOccurExcel";
        } else {
          exportUrl = window.LOCAL_CONFIG.API_HOME + "/ce/impawn/occurQuery/func_exportImpawnBillOccurExcel";
        }
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          options.params = {
