          ...
          <div class="h-form-search-box">
            <h-panel class="clearfix" :class="{'h-form-overhd':!ifShowMore}">
              <h-form :model="formItem" :label-width="90" ref="formItem" cols="4" class="h-form-search">
                ...
                <h-form-item :label="$t('m.i.pe.otherBrchName')" prop="saleBrchName">
                  <h-input v-model="formItem.saleBrchName" placeholder=""></h-input>
                </h-form-item>
                <h-form-item :label="$t('m.i.be.creditOccupyObj')" prop="occupyBankName">
                  <h-input v-model="formItem.occupyBankName" readonly
                           icon="android-search" @on-click="queryMemberName()" :maxlength="60" clearable
                           @on-clear="clearMemberName()"></h-input>
                </h-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      let batchColumns = [
        ...
        },
        {
          ...
          hiddenCol: false,
          render: (h, params) => {
            let dictValue = this.getDictValueFromMap(this.dictMap, "TraderBrchClass", params.row.saleBrchClass);
            return h("span", {
              domProps: {
                title: dictValue
              }
        ...
        {
          title: this.$t("m.i.pe.saleTraderName"),
          key: "saleTraderName",
          hiddenCol: false
        },
        {
      ...
      return {
        ...
        billColumns: [
          ...
          },
          {
            ...
            sortable: true,
            render: (h, params) => {
              if (params.row.discDt == null || params.row.discDt === "" || params.row.discDt === 0) {
                return "";
              }
          ...
          {
            title: this.$t("m.i.pe.assetIndustry"),
            key: "assetIndustry",
            hiddenCol: true,
            render: (h, params) => {
              let dictValue = this.getDictValueFromMap(this.dictMap, "AssetIndustry", params.row.assetIndustry);
          ...
          {
            title: this.$t("m.i.be.creditOccupyObj"),
            key: "occupyBankName",
            sortable: true,
            hiddenCol: false,
          },
        ...
        queryUrl: "/be/market/quote/rebuy/rebuyOccurQuery/func_findOccurRebuyBatch",
        ...
        showDetilBox: false,
        queryRebuyOccurUrl: "/be/market/quote/rebuy/rebuyOccurQuery/getSumAmtInfo",
        batchId: "",
        busiType: "",
        openI9flag: false,
      };
    ...
    methods: {
      ...
      clearMemberName() {
        this.formItem.occupyBankNo = "";
        this.formItem.occupyBankName = "";
      },
      memberIdWinClose() {
      ...
      memberIdWinSubmit(info) {
        ...
        this.formItem.occupyBankNo = info.memberBankNo;
        this.formItem.occupyBankName = info.memberName;
        this.showCpesMemberWin = false;
      },
      ...
      getOccurData() {
        post(this.formItem, this.queryRebuyOccurUrl).then(res => {
            if (res) {
      ...
      queryRebuyOccurBatch() {
        this.queryUrl = "/be/market/quote/rebuy/rebuyOccurQuery/func_findOccurRebuyBatch";
        this.queryRebuyOccurUrl = "/be/market/quote/rebuy/rebuyOccurQuery/getSumAmtInfo";
      ...
      queryRebuyOccurBill() {
        this.queryUrl = "/be/market/quote/rebuy/rebuyOccurQuery/func_findOccurRebuyBill";
        this.queryRebuyOccurUrl = "/be/market/quote/rebuy/rebuyOccurQuery/getSumAmtInfoByBill";
      ...
      tempShowExcelTemplateWinOpen(type) {
        ...
        if (type === "batch") {
          this.param = "rebuyBatchOccurExportInfo";
        } else {
          this.param = "rebuyBillOccurExportInfo";
        }
      ...
      exportList(field, exportType) {
        ...
        if (this.selectExportType === "batch") {
          exportUrl = window.LOCAL_CONFIG.API_HOME + "/be/market/quote/rebuy/rebuyOccurQuery/func_exportRebuyBatchOccurExcel";
        } else {
          exportUrl = window.LOCAL_CONFIG.API_HOME + "/be/market/quote/rebuy/rebuyOccurQuery/exportRebuyBillOccurExcel";
        }
        let options = {};
        if (this.$refs.datagrid.selectIds.length !== 0) {
          if (this.selectExportType === "batch") {
