  ...
  export default {
    ...
    methods: {
      ...
      getBillManagerDataList() {
        let url = "/pe/print/voucherPrint/voucherPrintManger/func_pageQueryPrsttnBill";
        post({
          "batchId": this.batchId,
          "ids": this.listIds,
      ...
      //获取批次详细信息
      getBatchInfo() {
        post({id:this.batchId,listIds:this.listIds}, "/pe/print/voucherPrint/voucherPrintManger/func_getPrsttnBatchByConditon").then(res => {
          if(res) {
            let msg = res.data.retMsg;
            let retCode = res.data.retCode;
            if (retCode === "000000") {
