      ...
      <h-col span="24">
        <div>
          ...
          <h-datagrid
            :columns="columns"
            highlightRow
            url="/shcpe/cpes/clickcreditdata/queryClickCreditDataPage"
            :bindForm="formItem"
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      /*    {
          ...
          },
          {
            ...
            hiddenCol: false,
            render: (h, params) => {
              let list = this.getDictValueFromMap(this.dictMap, "CreditRelationModel", params.row.creditRelationModel);
              return h("span",
                {
                  domProps: {
                    title: list
    ...
    mounted() {
      this.getDictListByGroups("BusiType,CreditRelationModel,TradeType,TenorVarieties").then(res => {
