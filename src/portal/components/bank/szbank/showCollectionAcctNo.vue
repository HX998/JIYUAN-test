  ...
  export default {
    ...
    methods: {
      ...
      doubleHandleClick(arr) {
        this.currentSelectRow = arr;
        this.$emit("collectionAcctNoSelectSubmit", this.currentSelectRow);
      },
      //查询
      formSearch() {
        this.currentSelectRow = [];
      ...
      submitForm() {
        ...
        // 选择客户
        this.$emit("collectionAcctNoSelectSubmit", this.currentSelectRow[0]);
      },
      handleClose() {
        this.$emit("showCollectionAcctNoWinClose", "");
      }
    }
  };
</script>
