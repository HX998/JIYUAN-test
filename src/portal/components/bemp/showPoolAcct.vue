<!--客户账号信息-->
<template>
  <h-msg-box v-model="tempshowPoolAcctWin" :maximize="true" :mask-closable="false" @on-close="handleClose"
    ...
    <div>
      ...
      <h-form :model="formItem" :label-width="80" ref="formItem" cols="4" class="h-form-search"
        ...
        <div>
          ...
          <h-form-item :label="$t('m.i.common.subAcctSrlNo')" prop="subAcctSrlNo" v-if="isSubAcctWorks == '1'">
  ...
  export default {
    ...
    methods: {
      ...
      handleClose() {
        ...
        this.$emit("showPoolAcctWinClose", this.updateFlag);
        this.updateFlag = "";
      },
      formSearch() {
    ...
    created(){
      getSingleParamValuesByKeys("bm.cust.is_sub_acct_works,pc.is_marketing_bank_mode").then(res => {
