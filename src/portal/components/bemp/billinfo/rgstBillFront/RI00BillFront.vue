    ...
    <div class="h-ticket-table" ref="body">
      <table>
        ...
        <tr>
          ...
          <td colspan="2" class="th">承兑日期</td>
          <td>{{formatDate(billInfo.acptDt)}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">承兑人全称</td>
          <td>{{billInfo.acptName}}</td>
          <td colspan="2" class="th">承兑人账号</td>
        ...
        <tr>
          <td colspan="2" class="th">承兑人统一信用代码</td>
          <td>{{billInfo.acptSocCode}}</td>
        ...
        <tr>
          ...
          <td colspan="2" class="th">出票人统一社会信用代码</td>
          <td>{{billInfo.drwrSocCode}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">出票人行业分类</td>
          <td>{{format("Industry", billInfo.drwrIndustry)}}</td>
          <td colspan="2" class="th">出票人企业规模</td>
          <td>{{format("CorpScale", billInfo.drwrCorpScale)}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">出票人是否涉农企业</td>
          <td>{{format("Yon", billInfo.isDrwrArc)}}</td>
          <td colspan="2" class="th">出票人地区</td>
          <td>{{format("Province", billInfo.drwrArea)}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">出票人是否绿色企业</td>
          <td>{{format("Yon", billInfo.isDrwrGrn)}}</td>
        ...
        <tr>
          ...
          <td colspan="2" class="th">收款人统一社会代码</td>
          <td>{{billInfo.pyeeSocCode}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">付款行行号</td>
          <td>{{billInfo.drweBankNo}}</td>
          <td colspan="2" class="th">付款人开户行行名</td>
