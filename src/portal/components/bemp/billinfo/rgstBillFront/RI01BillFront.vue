    ...
    <div class="h-ticket-table" ref="body">
      <table>
        ...
        <tr>
          ...
          <td colspan="2" class="th">质押日期</td>
          <td>{{formatDate(billInfo.rgstDt)}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">出质人名称</td>
          <td>{{billInfo.transFromName}}</td>
          <td colspan="2" class="th">出质人账号</td>
          <td>{{billInfo.transFromAcctNo}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">出质人开户行行号</td>
          <td>{{billInfo.transFromBankNo}}</td>
          <td colspan="2" class="th">出质人统一社会信用代码</td>
          <td>{{billInfo.transFromSocCode}}</td>
        </tr>
        <tr>
          <td colspan="2" class="th">质权行行号</td>
          <td>{{billInfo.transToBankNo}}</td>
          <td colspan="2" class="th">质权行行名</td>
