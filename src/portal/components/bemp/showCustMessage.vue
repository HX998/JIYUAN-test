  ...
  export default {
    ...
    watch: {
      showCustMessageWin(val) {
        if (val === true) {
          this.getDictInfo();
          this.datagridUrl = this.licenseFlag ? '/bm/cust/corp/pageQueryLicenseCustCorpList':'/bm/cust/corp/pageQueryCustCorpList';
          ...
          this.$nextTick(() => {
            ...
            this.formItem.ownedBrchNos = this.ownedBrchNos;
